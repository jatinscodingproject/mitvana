import trending1 from "@assets/images/home-flower/pr-trending-01.png"
import trending2 from "@assets/images/home-flower/pr-trending-02.png"
import trending3 from "@assets/images/home-flower/pr-trending-03.png"
import trending4 from "@assets/images/home-flower/pr-trending-04.png"
import trending5 from "@assets/images/home-flower/pr-trending-05.png"
import trending6 from "@assets/images/home-flower/pr-trending-06.png"
import trending9 from "@assets/images/home-flower/pr-trending-09.png"
import trending10 from "@assets/images/home-flower/pr-trending-10.png"

import mega9 from "@assets/images/megamenu/pr-09.jpg"
import mega11 from "@assets/images/megamenu/pr-11.jpg"

import pr14 from "@assets/images/products/pr-14.jpg"
import pr35 from "@assets/images/products/pr-35.jpg"

const homePageflower = [
    ...
    { id: "homeGlasses", label: "Home Glasses", link: "/home-glasses", badge: "new", badgeColor: "badge-tag badge bg-green2" },
...
const homePage2 = [
    ...
    { id: "homeSport", label: "Home Sport", link: "/home-sport", badge: "new", badgeColor: "badge-tag badge bg-green2" },
    { id: "homeJewelry", label: "Home Jewelry", link: "/home-jewelry", badge: "new", badgeColor: "badge-tag badge bg-green2" }
]

const featuresflower = [
    ...
    { id: "compare", label: "Compare", link: "/home-shoes", badge: "new", badgeColor: "badge-tag badge bg-green2" },
    { id: "pickupAvailability", label: "Pickup Availability", link: "/product-detail-pickup-availability", badge: "Selling feature", badgeColor: "position-absolute badge bg-green2 rounded-pill fw-normal text-white", badgeStyle: { "left": "103%", "top": "10px" } }
]
...
const slidesData = [
    ...
    {
        imageUrl: trending5,
        hoverImageUrl: trending6,
        title: "Seasonal Arrangement",
        price: "$95.00"
    },
    {
        imageUrl: trending1,
        hoverImageUrl: trending2,
        title: "Regular Succulent Shebang",
        price: "$125.00"
    },
    {
        imageUrl: trending9,
        hoverImageUrl: trending10,
...
export { homePageflower, homePage2, featuresflower, saleflower, slidesData }