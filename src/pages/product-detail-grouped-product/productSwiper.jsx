...
import product1 from "@assets/images/single-product/grouped-products/thumb-01.jpg"
import product2 from "@assets/images/single-product/grouped-products/thumb-02.jpg"
import product3 from "@assets/images/single-product/grouped-products/thumb-03.jpg"
import product4 from "@assets/images/single-product/grouped-products/thumb-04.jpg"
import tableImg1 from "@assets/images/single-product/grouped-products/grouped-01.jpg"
import tableImg2 from "@assets/images/single-product/grouped-products/grouped-02.jpg"
import tableImg3 from "@assets/images/single-product/grouped-products/grouped-03.jpg"
import tableImg4 from "@assets/images/single-product/grouped-products/grouped-04.jpg"
import productTrust from '@assets/images/single-product/trust_img2.png'
...
const ProductSwiper = ({ handleShoppingShow }) => {
    ...
    const handleQuantityChange1 = (change) => {
        setQuantity1((prev) => Math.max(0, prev + change));
    };
    ...
    const handleQuantityChange3 = (change) => {
    ...
    const handleQuantityChange4 = (change) => {
        setQuantity4((prev) => Math.max(0, prev + change));
    };
            ...
            <Container className='py-4'>
                <Row className='py-3 gx-xl-1'>
                    ...
                    <Col md={6} className='mt-5 mt-md-0'>
                        <h4 className="mb-3">Women clothing combo</h4>
                        <div className="d-flex flex-wrap justify-content-between">
                            <p className="text-muted fs-18 mb-4">$3.50-$30.00</p>
                        ...
                        <p className="text-muted lh-lg pb-1">
                        ...
                        <Table className="table table-bordered mx-auto">
                            <tbody>
                                <tr>
                                    <th scope="row">
                                        <Image src={tableImg1} className="img-fluid ms-lg-3" alt="" />
                                    </th>
                                    <td>
                                        <div className="p-lg-3 text-center">
                                            <h6 className="fw-medium">Striped Long Sleeve Top</h6>
                                            <select className="form-select form-select-sm rounded-0 py-2 my-3" id="address_province_ship">
                                                <option value="Alabama">Black / S</option>
                                                <option value="Alaska">Black / M</option>
                                                <option value="American Samoa">Black / L</option>

                                            </select>
                                            <p className="text-muted mb-0">$45.00 <del className="text-danger">$20.00</del></p>
                                        </div>
                                    </td>
                                    <td>
                                        <div className="input-step border border-muted mt-5 ms-lg-4 ">
                                            <Button type="button" className="minus material-shadow text-dark fw-bold" onClick={() => handleQuantityChange1(-1)}>–</Button>
                                            <input type="number" className="product-quantity fw-bold fs-6" value={quantity1} min="0" max="100" onChange={handleChange1} />
                                            <Button type="button" className="plus material-shadow text-dark fw-bold" onClick={() => handleQuantityChange1(+1)}>+</Button>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">
                                        <Image src={tableImg2} className="img-fluid ms-lg-3" alt="" />
                                    </th>
                                    <td>
                                        <div className="mt-lg-5 text-center">
                                            <h6 className="fw-medium">Ritson Original Mom Jeans</h6>
                                            <p className="text-muted mb-0">$22.00 </p>
                                        </div>
                                    </td>
                                    <td>
                                        <div className="input-step border border-muted mt-5 ms-lg-4 ">
                                            <Button type="button" className="minus material-shadow text-dark fw-bold" onClick={() => handleQuantityChange2(-1)}>–</Button>
                                            <input type="number" className="product-quantity fw-bold fs-6" value={quantity2} min="0" max="100" onChange={handleChange2} />
                                            <Button type="button" className="plus material-shadow text-dark fw-bold" onClick={() => handleQuantityChange2(+1)}>+</Button>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">
                                        <Image src={tableImg3} className="img-fluid ms-lg-3" alt="" />
                                    </th>
                                    <td>
                                        <div className="mt-lg-5 text-center">
                                            <h6 className="fw-medium">Organza Hair Scrunchie</h6>
                                            <p className="text-muted mb-0">$45.00 <del className="text-danger">$20.00</del></p>
                                        </div>
                                    </td>
                                    <td>
                                        <div className="input-step border border-muted mt-5 ms-lg-4 ">
                                            <Button type="button" className="minus material-shadow text-dark fw-bold" onClick={() => handleQuantityChange3(-1)}>–</Button>
                                            <input type="number" className="product-quantity fw-bold fs-6" value={quantity3} min="0" max="100" onChange={handleChange3} />
                                            <Button type="button" className="plus material-shadow text-dark fw-bold" onClick={() => handleQuantityChange3(+1)}>+</Button>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">
                                        <Image src={tableImg4} className="img-fluid ms-lg-3" alt="" />
                                    </th>
                                    <td>
                                        <div className="p-lg-3 text-center">
                                            <h6 className="fw-medium">Retro Lace Up Sneakers</h6>
                                            <select className="form-select form-select-sm rounded-0 py-2 my-3" id="address_province_ship">
                                                <option value="Alabama">UK 2</option>
                                                <option value="Alaska">UK 3</option>
                                                <option value="American Samoa">UK 1</option>

                                            </select>
                                            <p className="text-muted mb-0">$45.00 <del className="text-danger">$30.00</del></p>
                                        </div>
                                    </td>
                                    <td>
                                        <div className="input-step border border-muted mt-5 ms-lg-4 ">
                                            <Button type="button" className="minus material-shadow text-dark fw-bold" onClick={() => handleQuantityChange4(-1)}>–</Button>
                                            <input type="number" className="product-quantity fw-bold fs-6" value={quantity4} min="0" max="100" onChange={handleChange4} />
                                            <Button type="button" className="plus material-shadow text-dark fw-bold" onClick={() => handleQuantityChange4(+1)}>+</Button>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                        </Table>
                        <h4 className="my-3 py-1 text-black fw-medium">
                            Subtotal :
                            <span className="text-muted">
                                <del>$117.00</del>
                            </span>&nbsp;
                            <span className="text-danger">$75.40</span>
                        </h4>
