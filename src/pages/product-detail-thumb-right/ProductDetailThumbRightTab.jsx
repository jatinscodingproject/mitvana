...
const ProductDetailThumbRightTab = () => {
    ...
    const handleRightModal4Show = () => setModalShow4(true);
                                    ...
                                    <Tab.Pane eventKey="Description">
                                        ...
                                        <div className="mt-5">
                                            <div className="position-relative">
                                                ...
                                                <div className="pin-type position-absolute position-14">
                                                    <span className="zoompin"></span>
                                                    <Link href="#pinType6" className="bg_color_red text-white rounded-circle d-flex align-items-center justify-content-center position-relative" data-bs-toggle="modal" onClick={handleRightModal4Show}>
                                                        <i className="nav_link_icon position-relative"></i>
                                                    </Link>
                                                </div>
                                            </div>
...
export default ProductDetailThumbRightTab