...
import thumb1 from '@assets/images/single-product/variant-images-grouped/thumb-01.jpg'
import thumb2 from '@assets/images/single-product/variant-images-grouped/thumb-02.jpg'
import thumb3 from '@assets/images/single-product/variant-images-grouped/thumb-03.jpg'
import thumbs2 from '@assets/images/products/fbt_thumb-02.jpg'
import thumbs3 from '@assets/images/products/fbt_thumb-03.jpg'
import thumbs4 from '@assets/images/products/fbt_thumb-04.jpg'
                ...
                <Container>
                    <Row className="py-3 gx-xl-1">
                            ...
                            <Row className="g-2">
                                <Col xl={2} className="mt-xl-3 mt-2 order-2 order-xl-1">
                                    ...
                                    >
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image src={thumb1} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={thumb2} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={thumb3} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                        </div>
                                    </Swiper>
                                </Col>
                                ...
                                <Col xl={9} className="mt-3 order-1 order-xl-2">
                                    <Swiper
                                        ...
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image className="img-fluid w-100" src={thumb1} alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image className="img-fluid w-100" src={thumb2} alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image className="img-fluid w-100" src={thumb3} alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image className="img-fluid w-100" src={thumb2} alt="" />
                                            </SwiperSlide>
                        ...
                        <Col md={6} className="mt-5 mt-md-0">
                            <h4 className="mb-3">Skin Sweatpans</h4>
                            <div className="d-flex flex-wrap justify-content-between">
                                <p className="text-muted fs-18 mb-4"><del>$75.00</del><span className="text-danger">$45.00</span></p>
                                <div id="tab_reviews_product">
                                    <div className="kalles-rating-result">
                                        <span className="kalles-rating-result__pipe">
                                            ...
                                            <span className="kalles-rating-result__start kalles-rating-result__start--big de-active me-1"></span>
                                        </span>
                            ...
                            <div className="d-flex flex-wrap align-items-center gap-2 mt-4">
                                ...
                                <Button variant="teal" className="btn btn-teal text-uppercase rounded-pill min-w-150" onClick={handleShoppingShow}>
                                    Add to Cart
                                </Button>
                            ...
                            <div className="mt-4">
                                ...
                                <p className="mb-0">
                                    <span>Tag :</span>
                                    <span className="text-muted">
                                        <Link href="#!" className="text-muted">Fashion,</Link>
                                        <Link href="#!" className="text-muted">Girl,</Link>
                                        <Link href="#!" className="text-muted">Swim,</Link>
                                        <Link href="#!" className="text-muted">Clothing,</Link>
                                        <Link href="#!" className="text-muted">Summer</Link>
                                    </span>
                                </p>
                            </div>
                                        ...
                                        <ul className="list-unstyled m-0 p-0 d-flex flex-wrap align-items-center gap-2">
                                            <li className="d-inline-block">
                                                <Link href="/product-detail-layout-01">
                                                    <Image src={thumb1} alt="" style={{ width: "115px", height: "147px", objectFit: "cover" }} />
                                                </Link>
                                            </li>
                                            ...
                                            <li className="d-inline-block">
                                                <Link href="/product-detail-layout-01">
                                                    <Image src={thumbs2} alt="" style={{ width: "115px", height: "147px", objectFit: "cover" }} />
                                                </Link>
                                            </li>
                                            <li className="d-inline-block fs-4 text-muted">
                                                +
                                            ...
                                            <li className="d-inline-block">
                                                <Link href="/product-detail-layout-01">
                                                    <Image src={thumbs3} alt="" style={{ width: "115px", height: "147px", objectFit: "cover" }} />
                                                </Link>
                                            </li>
                                            <li className="d-inline-block fs-4 text-muted">
                                                +
                                            ...
                                            <li className="d-inline-block">
                                                <Link href="/product-detail-layout-01">
                                                    <Image src={thumbs4} alt="" style={{ width: "115px", height: "147px", objectFit: "cover" }} />
                                                </Link>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <ul className="list-unstyled m-0 p-0 vstack gap-3">
                                            <li className="d-flex flex-wrap align-items-center">
                                                ...
                                                <span className="text-muted"><strong>This item:</strong> Striped Long Sleeve
                                                    Top</span>
                                                <select className="form-select w-auto d-inline-block ps-2 pe-4 py-1 mx-2" style={{ backgroundPosition: "right .5rem center", backgroundSize: "12px 10px" }}>
                                                    <option value="black-s" defaultValue="black / S">Black / S</option>
                                            ...
                                            <li className="d-flex flex-wrap align-items-center">
                                                ...
                                                <select className="form-select product-form-select w-auto d-inline-block ps-2 pe-4 py-1 mx-2" style={{ backgroundPosition: "right .5rem center", backgroundSize: "12px 10px" }}>
                                                    <option value="uk2" defaultValue="UK 2">UK 2</option>
