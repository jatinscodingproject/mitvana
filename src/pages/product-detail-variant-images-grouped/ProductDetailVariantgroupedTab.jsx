...
const ProductDetailVariantgroupedTab = () => {
                                ...
                                <Tab.Content className="mt-5">
                                    <Tab.Pane eventKey="Description">
                                        ...
                                        <Row className="my-5 g-3">
                                            <Col md={4}>
                                                <Image src={thumb1} className="img-fluid" alt="" />
                                            </Col>
                                            <Col md={4} >
                                                <Image src={thumb2} className="img-fluid" alt="" />
                                            </Col>
                                            <Col md={4} >
                                                <Image src={thumb3} className="img-fluid" alt="" />
                                            </Col>
                                        </Row>
...
export default ProductDetailVariantgroupedTab