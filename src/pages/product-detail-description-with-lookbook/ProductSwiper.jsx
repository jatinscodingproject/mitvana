...
import product01 from '@assets/images/single-product/description-with-lookbook/full-size-01.jpg'
import product02 from '@assets/images/single-product/description-with-lookbook/full-size-02.jpg'
import product03 from '@assets/images/single-product/description-with-lookbook/full-size-03.jpg'
                    ...
                    <Row className="py-3 gx-xl-1">
                        ...
                        <Col md={6} className="mt-5 mt-md-0">
                            ...
                            <div className="d-flex flex-wrap justify-content-between">
                                <p className="text-muted fs-18 mb-4"><del>$45.00</del><span className="text-danger">$20.00</span></p>
