...
import thumb1 from '@assets/images/single-product/thumb-01.jpg'
import thumb2 from '@assets/images/single-product/thumb-02.jpg'
import thumb3 from '@assets/images/single-product/thumb-03.jpg'
import thumb4 from '@assets/images/single-product/thumb-04.jpg'
import thumb5 from '@assets/images/single-product/thumb-05.jpg'
import thumb7 from '@assets/images/single-product/thumb-07.jpg'
            ...
            <section className="py-4">
                <Container>
                    <Row className="py-3 gx-xl-4">
                            ...
                            <Row className="g-2">
                                <div className="col-12">
                                    <div>
                                        ...
                                        <Image src={thumb2} alt="" className="img-fluid w-100 mt-4" />
                                        <Image src={thumb3} alt="" className="img-fluid w-100 mt-4" />
                                        <Image src={thumb4} alt="" className="img-fluid w-100 mt-4" />
                                        <Image src={thumb5} alt="" className="img-fluid w-100 mt-4" />
                                        <Image src={thumb7} alt="" className="img-fluid w-100 mt-4" />
                                    </div>
                                </div>
                            </Row>
                        </Col>
                        ...
                        <Col md={6}>
                            <div className="position-sticky mt-4 mt-md-0" style={{ top: "1.5rem" }}>
                                <h4 className="mb-3">Blush Beanie</h4>
                                <div className="d-flex flex-wrap justify-content-between">
                                    <p className="text-muted fs-18 mb-4">$50.00</p>
