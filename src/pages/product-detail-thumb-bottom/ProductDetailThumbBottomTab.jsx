...
const ProductDetailThumbBottomTab = () => {
                                    ...
                                    <Tab.Pane eventKey="Description">
                                        <div className="container">
                                            <Row className="align-items-center">
                                                <Col md={6}>
                                                    <p className="cb">Typography is the work of<em> typesetters, compositors, typographers,
                                                        graphic designers, art directors, manga artists, comic book artists, graffiti
                                                        artists</em>, and now—anyone who arranges words, letters, numbers, and symbols
                                                        for publication, display, or distribution—from clerical
                                                        <strong>workers and newsletter writers to anyone self-publishing materials.</strong>
                                                    </p>
                                                    <blockquote className="product-blockquote fs-13">
                                                        <p className="mb-0">As the capability to create typography has become ubiquitous, the
                                                            application of principles and best practices developed over generations of
                                                            skilled workers and professionals has diminished. Ironically, at a time when
                                                    ...
                                                    <p className="cb">Until the Digital Age, typography was a specialized occupation.
                                                        ...
                                                        capability to create typography has become ubiquitous, the application of principles
                                                        and best practices developed over generations of skilled workers
                                                        and professionals has diminished. Ironically, at a time when scientific techniques.
                                                    </p>
                                                </Col>
                                                <Col md={6}>
                                                    <Row className="g-4">
...
export default ProductDetailThumbBottomTab