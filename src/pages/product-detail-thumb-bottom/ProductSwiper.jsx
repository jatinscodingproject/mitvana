                        ...
                        <Col md={6}>
                            <div>
                                <div>
                                    <Swiper
                                        ...
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image src={pro15} alt="" className="img-fluid w-100" priority />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={pro16} alt="" className="img-fluid w-100" priority />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                ...
                                <div className="mt-3">
                                    ...
                                    >
                                        <SwiperSlide>
                                            <Image src={pro15} alt="" className="w-100 h-auto object-fit-contain" priority />
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <Image src={pro16} alt="" className="w-100 h-auto object-fit-contain" priority />
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <Image src={thumb5} alt="" className="w-100 h-auto object-fit-contain" priority />
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <Image src={thumb6} alt="" className="w-100 h-auto object-fit-contain" priority />
                                        </SwiperSlide>
                                    </Swiper>
                                </div>
                            </div>
                        ...
                        <Col md={6} className="mt-5 mt-xl-0">
                            ...
                            <div>
                                ...
                                <div className="product-color-list mt-2 gap-2 d-flex align-items-center">
                                    <OverlayTrigger
                                        placement="top"
                                        overlay={<Tooltip id="tooltip-white-cream">White Cream</Tooltip>}
                                    >
                                        <Link
                                            href="#!"
                                            className={`d-inline-block rounded-circle square-xs ${color === 'White Cream' ? 'active' : ''}`}
                                            style={{ backgroundImage: `url(${dot1.src}) no-repeat center / cover` }}
                                            onClick={(e) => { e.preventDefault(); handleColorClick('White Cream'); }}
                                        ></Link>
                                    </OverlayTrigger>
                                    <OverlayTrigger
                                        placement="top"
                                        overlay={<Tooltip id="tooltip-heart-dotted">HEART DOTTED</Tooltip>}
                                    >
                                        <Link
                                            href="#!"
                                            className={`d-inline-block rounded-circle square-xs ${color === 'HEART DOTTED' ? 'active' : ''}`}
                                            style={{ background: `url(${dot2.src}) no-repeat center / cover` }}
                                            onClick={(e) => { e.preventDefault(); handleColorClick('HEART DOTTED'); }}
                                        ></Link>
                                    </OverlayTrigger>
                                </div>
                            </div>
