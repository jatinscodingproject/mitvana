...
import { Row, Col, Nav, Tab, Tabs, Modal, Card, CardBody, Dropdown } from 'react-bootstrap';
import Image from "next/image";
import Link from "next/link";
import thumb03 from '@assets/images/single-product/3d-ar-models/thumb-03.png';
                                ...
                                <Tab.Content className="mt-5">
                                    <Tab.Pane eventKey="Description">
                                        ...
                                        <Row className="align-items-center pt-5">
                                            ...
                                            <Col md={6}>
                                                <Image src={thumb03} className="img-fluid" alt="" />
                                            </Col>
                                            <Col md={3}>
