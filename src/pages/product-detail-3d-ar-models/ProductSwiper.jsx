...
import thumb01 from '@assets/images/single-product/3d-ar-models/thumb-01.png'
import thumb04 from '@assets/images/single-product/3d-ar-models/thumb-04.png'
                ...
                <Container>
                    <Row className="py-3 gx-xl-1">
                        <Col md={6}>
                            ...
                            <Row className="g-2">
                                <Col xl={2} className="mt-xl-3 mt-2 order-2 order-xl-1 bag-swiper">
                                    ...
                                    >
                                        <div className="swiper-wrapper">
                                            ...
                                            <SwiperSlide>
                                                <Image src={thumb04} className="object-fit-cover" alt="" />
                                ...
                                <Col xl={9} className="mt-3 order-1 order-xl-2">
                                    <Swiper
                                        ...
                                        <div className="swiper-wrapper">
                                            <div className="swiper-wrapper">
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={thumb01} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={thumb04} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={thumb03} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={thumb01} alt="" />
                                                </SwiperSlide>
                        ...
                        <Col md={6} className="mt-5 mt-md-0">
                            <h4 className="mb-3">Dance Bag Nylon</h4>
                            <div className="d-flex flex-wrap justify-content-between">
                                <p className="text-muted fs-18 mb-4">$18.00</p>
