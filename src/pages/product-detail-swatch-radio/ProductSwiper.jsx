                                ...
                                <Col xl={2} className="mt-xl-3 mt-2 order-2 order-xl-1">
                                    ...
                                    >
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image src={product4} className="object-fit-cover" alt="product1" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product5} className="object-fit-cover" alt="product5" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product31} className="object-fit-cover" alt="product5" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product42} className="object-fit-cover" alt="product42" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product43} className="object-fit-cover" alt="product43" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product32} className="object-fit-cover" alt="product32" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product44} className="object-fit-cover" alt="product44" />
                                            </SwiperSlide>
                                        </div>
                                    </Swiper>
                                </Col>
                        ...
                        <Col md={6} className="mt-5 mt-md-0">
                            ...
                            <div className="pt-2">
                                ...
                                <div className="d-flex">
                                    <div className="form-check">
                                        ...
                                        />
                                        <label className="form-check-label" htmlFor="flexRadioDefault4">Gray</label>
                                    </div>
                                    <div className="form-check mx-2">
                                        <input
                                            ...
                                            onChange={handleColorChange}
                                        />
                                        <label className="form-check-label" htmlFor="flexRadioDefault5">Pink</label>
                                    </div>
                                    <div className="form-check">
                                        <input
                                            className="form-check-input product-radio"
                                            ...
                                            onChange={handleColorChange}
                                        />
                                        <label className="form-check-label" htmlFor="flexRadioDefault6">Black</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="d-flex align-items-center gap-2 mt-4">
                                ...
                                <div className="w-full flex-grow-1">
                                    <Button variant="teal" className="btn btn-teal w-100 text-uppercase rounded-pill min-w-150" onClick={handleShoppingShow}>
                                        Add to Cart
                                    </Button>
                                </div>
                            ...
                            <div className="mt-3">
                                <Link href="#!" className="btn w-100 rounded-pill btn-dark fw-medium">BUY IT NOW</Link>
                            </div>
