...
import thumb2 from '@assets/images/single-product/left-sidebar/thumb-02.jpg'
import thumb3 from '@assets/images/single-product/left-sidebar/thumb-03.jpg'
import thumb4 from '@assets/images/single-product/left-sidebar/thumb-04.jpg'
import thumb5 from '@assets/images/single-product/left-sidebar/thumb-05.jpg'
...
const ProductSwiper = ({ handleShoppingShow }) => {
    ...
    return (
        <React.Fragment>
            <div className="col-lg-6 col-xl-4 order-1 order-xl-2">
                <div>
                    <div>
                        <Swiper
                            navigation={true}
            ...
            <Col lg={6} xl={5} className="mt-5 mt-xl-0 order-2 order-xl-3">
                <h4 className="mb-3">Men pants</h4>
