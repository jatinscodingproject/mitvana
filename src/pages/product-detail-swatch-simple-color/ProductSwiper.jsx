                            ...
                            <Row className="g-2">
                                ...
                                <Col xl={9} className="mt-3 order-1 order-xl-2">
                                    <Swiper
                                        ...
                                        <div className="swiper-wrapper">
                                            <SwiperSlide >
                                                <Image className="drift-demo-trigger img-fluid w-100" data-zoom={product4} src={product4} alt="product4" />
                                            </SwiperSlide>
                                            <SwiperSlide >
                                                <Image className="drift-demo-trigger img-fluid w-100" data-zoom={product5} src={product5} alt="product5" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image className="drift-demo-trigger img-fluid w-100" data-zoom={product31} src={product31} alt="product31" />
                                            </SwiperSlide>
                                            <SwiperSlide className="product">
                                                <Image className="drift-demo-trigger img-fluid w-100" data-zoom={product42} src={product42} alt="product42" />
                                            </SwiperSlide>
                                            <SwiperSlide className="product">
                                                <Image className="drift-demo-trigger img-fluid w-100" data-zoom={product43} src={product43} alt="product43" />
                                            </SwiperSlide>
                                            <SwiperSlide className="product">
                                                <Image className="drift-demo-trigger img-fluid w-100" data-zoom={product32} src={product32} alt="product32" />
                                            </SwiperSlide>
                                            <SwiperSlide className="product">
                                                <Image className="drift-demo-trigger img-fluid w-100" data-zoom={product44} src={product44} alt="product44" />
                                            </SwiperSlide>
