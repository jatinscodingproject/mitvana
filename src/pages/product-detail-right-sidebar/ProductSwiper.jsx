...
import thumb1 from '@assets/images/single-product/right-sidebar/thumb-01.jpg'
import thumb2 from '@assets/images/single-product/right-sidebar/thumb-02.jpg'
import thumb3 from '@assets/images/single-product/right-sidebar/thumb-03.jpg'
import thumb4 from '@assets/images/single-product/right-sidebar/thumb-04.jpg'
...
const ProductSwiper = ({ handleShoppingShow }) => {
    ...
    return (
        <React.Fragment>
            <Col lg={6} xl={5} className="order-1 order-xl-1">
                <div>
                    <div>
                        <Swiper
                            navigation={true}
            ...
            <Col lg={6} xl={4} className="mt-5 mt-xl-0 order-2 order-xl-3">
                <h4 className="mb-3">Crosshatch Backpack</h4>
                <div className="d-flex flex-wrap justify-content-between">
                    <p className="text-muted fs-18 mb-4">$30.00</p>
                ...
                <div>
                    ...
                    <div className="product-color-list mt-2 gap-2 d-flex align-items-center">
                        ...
                        <OverlayTrigger placement="top" overlay={<Tooltip id="tooltip-pink">Black</Tooltip>}>
                            <Link
                                href="#!"
