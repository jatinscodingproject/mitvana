                                ...
                                <div className="accordion-body border border-top-0 border-light">
                                    <div className="container">
                                        <p className="text-black text-center">
                                            ...
                                            commodo,
                                            ipsum sed pharetra gravida, orci magna rhoncus neque, id pulvinar odio lorem non
                                            turpis. Nullam
                                        ...
                                        <Row className="align-items-center pt-5">
                                            <Col md={3}>
                                                ...
                                                <div className="text-center text-md-end d-md-flex flex-md-row-reverse align-items-center justify-md-content-end mb-5">
                                                    ...
                                                    <p className="me-2 mb-0 text-muted text-md-end">Corrosion Resistance<br />to Sea
                                                        water</p>
                                                </div>
                                            </Col>
                                            <Col md={6}>
