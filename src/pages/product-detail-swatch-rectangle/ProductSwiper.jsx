                    ...
                    <Row className="py-3 gx-xl-1">
                                ...
                                <Col xl={2} className="mt-xl-3 mt-2 order-2 order-xl-1">
                                    ...
                                    >
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image src={product4} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product5} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product31} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product42} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product43} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product32} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product44} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                        </div>
                                    </Swiper>
                                </Col>
                                <Col xl={9} className="mt-3 order-1 order-xl-2">
                                    <Swiper
                                        ...
                                        <div className="swiper-wrapper">
                                            <div className="swiper-wrapper">
                                                <SwiperSlide>
                                                    <Image className="drift-demo-trigger img-fluid w-100" src={product4} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="drift-demo-trigger img-fluid w-100" src={product5} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="drift-demo-trigger img-fluid w-100" src={product31} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="drift-demo-trigger img-fluid w-100" src={product42} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="drift-demo-trigger img-fluid w-100" src={product43} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="drift-demo-trigger img-fluid w-100" src={product32} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="drift-demo-trigger img-fluid w-100" src={product44} alt="" />
                                                </SwiperSlide>
                                            </div>
                        ...
                        <Col md={6} className="mt-5 mt-md-0">
                            ...
                            <div className="custome-radio">
                                ...
                                <div className="color-list mt-2 d-flex align-items-center">
                                    <Link href="#!" onClick={(e) => { handleColorClick('Gray'); }}>
                                        <div className={`button ${color === 'Gray' ? 'active' : ''}`}>
                                            <input
                                                type="radio"
                                                id="gray"
                                    ...
                                    <Link href="#!" onClick={(e) => { handleColorClick('Pink'); }}>
                                        <div className={`button ${color === 'Pink' ? 'active' : ''}`}>
                                            <input
                                                type="radio"
                                                id="pink"
                                                name="check-substitution-2"
                                    ...
                                    <Link href="#!" onClick={(e) => { handleColorClick('Black'); }}>
                                        <div className={`button ${color === 'Black' ? 'active' : ''}`}>
                                            <input
                                                type="radio"
                                                id="black"
                                                name="check-substitution-2"
                            ...
                            <div className="py-2">
                                ...
                                <div className="product-color-list size mt-2 gap-2 d-flex align-items-center">
                                    <Link
                                        href="#!"
                                        className="d-inline-block d-flex align-items-center justify-content-center"
                                        onClick={(e) => { handleSizeClick('S'); }}
                                    >
                                        <div className={`button ${size === 'S' ? 'active' : ''}`}>
                                            <input
                                                type="radio"
                                                id="sizeS"
                                                name="check-substitution-2"
                                                ...
                                                readOnly
                                            />
                                            <label htmlFor="sizeS" style={{ width: '32px' }}>S</label>
                                        </div>
                                    </Link>
                                    <Link
                                        href="#!"
                                        className="d-inline-block mx-2 d-flex align-items-center justify-content-center"
                                        onClick={(e) => { handleSizeClick('M'); }}
                                    >
                                        <div className={`button ${size === 'M' ? 'active' : ''}`}>
                                            <input
                                                type="radio"
                                                id="sizeM"
                                                name="check-substitution-2"
                                                ...
                                                readOnly
                                            />
                                            <label htmlFor="sizeM" style={{ width: '32px' }}>M</label>
                                        </div>
                                    </Link>
                                    <Link
                                        href="#!"
                                        className="d-inline-block d-flex align-items-center justify-content-center"
                                        onClick={(e) => { handleSizeClick('L'); }}
                                    >
                                        <div className={`button ${size === 'L' ? 'active' : ''}`}>
                                            <input
                                                type="radio"
                                                id="sizeL"
                                                name="check-substitution-2"
                                                ...
                                                readOnly
                                            />
                                            <label htmlFor="sizeL" style={{ width: '32px' }}>L</label>
                                        </div>
                                    </Link>
                                </div>
                            </div>
