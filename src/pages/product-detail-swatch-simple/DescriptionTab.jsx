                        ...
                        <Row className="nav tab_header justify-content-center">
                            <Col>
                                <Nav variant="pills" className="tab_header nav_tabs justify-content-center">
                                    <Nav.Item>
                                        <Nav.Link eventKey="Description" className="rounded-pill pill-border fw-medium">
                                            Description
                                        </Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="Additionalinformation" className="rounded-pill pill-border fw-medium">Additional Information</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="Warrantyshipping" className="rounded-pill pill-border fw-medium">Warranty & Shipping</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="Washcare" className="rounded-pill pill-border fw-medium">Wash & Care</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="Reviews" className="rounded-pill pill-border fw-medium">Reviews</Nav.Link>
                                    </Nav.Item>
                                </Nav>
                            </Col>
                        </Row>
                                ...
                                <Tab.Content className="mt-5">
                                    <Tab.Pane eventKey="Description">
                                        ...
                                        <Row className="my-5 g-3">
                                            <Col md={4}>
                                                <Image src={description1} className="img-fluid" alt="" />
                                            </Col>
                                            <Col md={4}>
                                                <Image src={description2} className="img-fluid" alt="" />
                                            </Col>
                                            <Col md={4}>
                                                <Image src={description3} className="img-fluid" alt="" />
                                            </Col>
                                        </Row>
