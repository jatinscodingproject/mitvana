...
import description1 from '@assets/images/single-product/simple-product/thumb-01.jpg';
import description2 from '@assets/images/single-product/simple-product/thumb-02.jpg';
import description3 from '@assets/images/single-product/simple-product/thumb-03.jpg';
import waterResistant from '@assets/images/single-product/water-resistant.png';
import uvResistant from '@assets/images/single-product/uv-resistant.png';
                                    ...
                                    <Tab.Pane eventKey="Description">
                                        ...
                                        <Row className="align-items-center pt-5">
                                            <Col md={3}>
                                                ...
                                                <div className="text-center text-md-end d-md-flex flex-md-row-reverse align-items-center justify-md-content-end mb-5">
                                                    <div>
                                                        <Image src={uvResistant} className="img-fluid" style={{ width: "44px" }} alt="" />
                                                    </div>
