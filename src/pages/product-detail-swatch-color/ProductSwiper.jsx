...
import gray from '@assets/images/swatch-color/option-grey.jpg'
import pink from '@assets/images/swatch-color/option-pink.jpg'
import black from '@assets/images/swatch-color/option-black.jpg'
                        ...
                        <Col md={6} className="mt-5 mt-md-0 ">
                            ...
                            <div>
                                <div className="custome-radio">
                                    ...
                                    <div className="image_radio_button_control">
                                        <label className={`radio-button-label ${color === 'Grey' ? 'active' : ''}`}>
                                            <input
                                                type="radio"
                                                name="radio-control"
                                                value="Grey"
                                            ...
                                            />
                                            <Image src={gray} alt="Grey" />
                                        </label>
                                        <label className={`radio-button-label ${color === 'Pink' ? 'active' : ''}`}>
                                            <input
                                                type="radio"
                                                name="radio-control"
                                                value="Pink"
                                        ...
                                        <label className={`radio-button-label ${color === 'Black' ? 'active' : ''}`}>
                                            <input
                                                type="radio"
                                                name="radio-control"
                                                value="Black"
