...
import { Container, Row, Col, Button, Nav, Tab, Tabs, Modal, Card, CardBody, Dropdown } from 'react-bootstrap';
                ...
                <div className="container">
                    <Tab.Container id="left-tabs-example" defaultActiveKey="first" activeKey={activeKey} onSelect={(k) => setActiveKey(k)}>
                        <Row className="nav tab_header justify-content-center">
                            <Col>
                                <Nav variant="pills" className="tab_header justify-content-center">
                                    <Nav.Item>
                            ...
                            <Col>
                                <Tab.Content className="mt-5">
                                    <Tab.Pane eventKey="Description">
                                        <Row className="pt-3">
                                            <Col lg={6}>
                                                <h5 className="fw-semibold text-center">FIGHTING FIT</h5>
                                                <p>Go sporty this summer with this vintage navy and white striped v-neck t-shirt from the
                                                    Abercrombie & Fitch. Perfect for pairing with denim and white kicks for a stylish sporty
                                                ...
                                                <p>Typography is the work of typesetters, compositors, typographers, graphic designers, art
                                                    directors, manga artists, comic book artists, graffiti artists, and now—anyone who
                                                ...
                                                <p>
                                                    ...
                                                    you to throw jabs and hooks at the punching bag with ease. A lightweight material keeps
                                                    you fighting fit, and fresh.
                                                </p>
                                            </Col>
                                            <Col lg={6}>
                                                <h5 className="fw-semibold text-center">FIND YOUR SIZE</h5>
                                                <table className="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col" className="bg-transparent fw-medium">SIZE</th>
                                                            <th scope="col" className="bg-transparent fw-medium">CHEST</th>
                                                            <th scope="col" className="bg-transparent fw-medium">WAIST</th>
                                                            <th scope="col" className="bg-transparent fw-medium">HIPS</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                            <th className="bg-transparent fw-medium" scope="row">S</th>
                                                            <td className="bg-transparent">39</td>
                                                            <td className="bg-transparent">31</td>
                                                            <td className="bg-transparent">35</td>
                                                        </tr>
                                                        <tr>
                                                            <th className="bg-transparent fw-medium" scope="row">M</th>
                                                            <td className="bg-transparent">41</td>
                                                            <td className="bg-transparent">44</td>
                                                            <td className="bg-transparent">37</td>
                                                        </tr>
                                                        <tr>
                                                            <th className="bg-transparent fw-medium" scope="row">L</th>
                                                            <td className="bg-transparent">43</td>
                                                            <td className="bg-transparent">35</td>
                                                            <td className="bg-transparent">39</td>
                                                        </tr>
                                                        <tr>
                                                            <th className="bg-transparent fw-medium" scope="row">XL</th>
                                                            <td className="bg-transparent">45</td>
                                                            <td className="bg-transparent">37</td>
                                                            <td className="bg-transparent">41</td>
                                                        </tr>
                                                        <tr>
                                                            <th className="bg-transparent fw-medium" scope="row">XXL</th>
                                                            <td className="bg-transparent">47</td>
                                                            <td className="bg-transparent">39</td>
                                                            <td className="bg-transparent">43</td>
                                                        </tr>
                                                    </tbody>
