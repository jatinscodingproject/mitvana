...
import product1 from "@assets/images/single-product/external-affiliate/thumb-01.jpg"
import product2 from "@assets/images/single-product/external-affiliate/thumb-02.jpg"
import product3 from "@assets/images/single-product/external-affiliate/thumb-03.jpg"
import product4 from "@assets/images/single-product/external-affiliate/thumb-04.jpg"
            ...
            <Container className='py-4'>
                <Row className='py-3 gx-xl-1'>
                    ...
                    <Col md={6} className='mt-5 mt-md-0'>
                        <h4 className="mb-3">Leather White Trainers</h4>
                        <div className="d-flex flex-wrap justify-content-between">
                            <p className="text-muted fs-18 mb-4">$20.00</p>
                        ...
                        <div className="d-flex flex-wrap align-items-center gap-2 ">
                            <Link href="/product-detail-layout-01" className="btn btn-outline-dark abc-btn text-dark fw-medium text-uppercase rounded-pill min-w-150">
                                Buy on ABC-Market
                            </Link>
