                                        ...
                                        <Row>
                                            <Col md={6} className="col-12">
                                                ...
                                                <p className="ffst-italic">
                                                    ...
                                                    t-shirt from the Nike. Perfect for pairing with denim and white kicks for a
                                                    stylish sporty vibe.
                                                </p>
                                                <h5 className="fw-medium">Facilisis scelerisque mi</h5>
                                                <p>Typography is the work of typesetters, compositors, typographers,
                                                    graphic designers, art directors, manga artists, comic book artists,
                                                    graffiti artists, and now—anyone who arranges words, letters, numbers, and
                                                    symbols for
                                            ...
                                            <Col md={6} className="col-12">
                                                ...
                                                <p>Digitization opened up typography to new generations of previously
                                                    ...
                                                    everybody
                                                    does. As the capability to create typography has become ubiquitous, the
                                                    application of principles and best practices developed over generations of
                                                    skilled workers and professionals has diminished. Ironically, at a time when
