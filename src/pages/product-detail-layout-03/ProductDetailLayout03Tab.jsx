...
const ProductDetailLayout03Tab = () => {
                        ...
                        <Row>
                            <Col>
                                <Tab.Content className="mt-5">
                                        ...
                                        <div className="container">
                                            <Row>
                                                <Col md={6} className="col-12">
                                                    <h5 className="fw-medium mt-3">Viverra a consectetur</h5>
                                                    <p className="ffst-italic">
                                                        Go sporty this summer with this vintage navy and white striped v-neck t-shirt from
                                                        the Nike. Perfect for pairing with denim and white kicks for a stylish sporty vibe.
                                                    </p>
                                                    ...
                                                    <p>Typography is the work of typesetters, compositors, typographers, graphic
                                                        designers, art directors, manga artists, comic book artists, graffiti artists, and
                                                        now—anyone who arranges words, letters, numbers, and symbols for
                                                        publication, display, or distribution—from clerical workers and newsletter writers
                                                        to anyone self-publishing materials.
                                                    </p>
                                                </Col>
                                                <Col md={6} className="col-12">
                                                    <h5 className="fw-medium">Ullamcorper metus</h5>
                                                    <p>As the capability to create typography has become ubiquitous, the
                                                        application of principles and best practices developed over generations of skilled
                                                        workers and professionals has diminished. Ironically, at a time when scientific
                                                        techniques.
                                                    </p>
                                                    <h5 className="fw-medium">Dignissim a leo cum</h5>
                                                    <p>Digitization opened up typography to new generations of previously unrelated
                                                        designers and lay users, and David Jury, head of graphic design at Colchester
                                                        Institute in England, states that “typography is now something everybody
                                                        does. As the capability to create typography has become ubiquitous, the application
                                                        of principles and best practices developed over generations of skilled workers and
                                                        professionals has diminished. Ironically, at a time when
                                    ...
                                    <Tab.Pane eventKey="Washcare" className="pe-3">
                                        <ul className="list-unstyled d-flex flex-wrap justify-content-center mb-0  mt-3">
                                            <li className="m-2">
                                    ...
                                    <Tab.Pane eventKey="Reviews">
                                        <Row className="mb-3 ">
                                            <Col md={2} className="text-center ">
                                                <p className="mb-0 mt-3">Average</p>
...
export default ProductDetailLayout03Tab;