...
import product01 from '@assets/images/single-product/back-in-stock-notification/thumb-01.jpg'
import product02 from '@assets/images/single-product/back-in-stock-notification/thumb-02.jpg'
import product03 from '@assets/images/single-product/back-in-stock-notification/thumb-03.jpg'
import product04 from '@assets/images/single-product/back-in-stock-notification/thumb-04.jpg'
                ...
                <Container>
                    <Row className="py-3 gx-xl-1">
                                ...
                                <Col xl={2} className="mt-xl-3 mt-2 order-2 order-xl-1">
                                    ...
                                    >
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image src={product01} className="object-fit-cover" alt="product1" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product02} className="object-fit-cover" alt="product5" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product03} className="object-fit-cover" alt="product5" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product04} className="object-fit-cover" alt="product42" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product03} className="object-fit-cover" alt="product43" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product04} className="object-fit-cover" alt="product32" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product02} className="object-fit-cover" alt="product32" />
                                            </SwiperSlide>
                                        </div>
                                    </Swiper>
                                </Col>
                        ...
                        <Col md={6} className="mt-5 mt-md-0">
                            <h4 className="mb-3">Analogue Resin Strap Watch</h4>
                            <div className="d-flex flex-wrap justify-content-between">
                                <p className="text-muted fs-18 mb-4"><span className="product-detail-back-in-stock-notification">$85.00</span></p>
                            ...
                            <div className="d-flex flex-wrap align-items-center gap-2 mt-4">
                                <Button variant="" className="btn btn-outline-dark fw-medium border-2 fw-semibold rounded-pill min-w-150" onClick={handleShoppingShow}>
                                    Out of Stock
                                </Button>
                            ...
                            <div className="mb-3">
                                <h6 className="border-top fs-16 py-3 mt-4">
                                    Notify me when this product is available:
                                </h6>
                                <label htmlFor="email" role="button" className="text-muted mb-1">Email address*</label>
                                <input className="form-control rounded-0" id="email" type="Email" aria-label="default input example" />
                            </div>
                            <Link href="#!">
                                <div className="btn btn-outline-dark border-2 fw-semibold rounded-pill min-w-150 mt-2">Email
                                    Me When
                                    Avilable</div>
                            </Link>
