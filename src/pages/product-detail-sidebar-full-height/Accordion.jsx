...
import icon from "@assets/images/single-product/icon-down.svg"
                    ...
                    <div className="accordion-flush product-accordion" id="accordionFlushExample">
                        <div className="accordion-item border-0 mb-2">
                            ...
                            <div id="flush-collapseOne" className={`accordion-collapse collapse ${open === 1 ? 'show' : ''}`} data-bs-parent="#accordionFlushExample">
                                <div className="accordion-body border border-top-0 border-light mt-3">
                                    <div className="container">
                                        <Row>
                                            <Col md={6} className="col-12">
                                                <h5 className="fw-medium">Viverra a consectetur</h5>
                                                <p className="ffst-italic">
                                                ...
                                                <h5 className="fw-medium">Facilisis scelerisque mi</h5>
                                                <p>Typography is the work of typesetters, compositors, typographers, graphic designers, art directors, manga artists, comic book artists, graffiti artists, and now—anyone who arranges words, letters, numbers, and symbols for
                                                    publication, display, or distribution—from clerical workers and newsletter writers to anyone self-publishing materials.
                                                </p>
                                            </Col>
                                            <Col md={6} className="col-12">
                                                <h5 className="fw-medium">Ullamcorper metus</h5>
                                                <p>As the capability to create typography has become ubiquitous, the application of principles and best practices developed over generations of skilled workers and professionals has diminished. Ironically, at a time when scientific
                                                    techniques.
                                                </p>
                                                <h5 className="fw-medium">Dignissim a leo cum</h5>
                                                <p>Digitization opened up typography to new generations of previously unrelated designers and lay users, and David Jury, head of graphic design at Colchester Institute in England, states that “typography is now something everybody
                                                    does. As the capability to create typography has become ubiquitous, the application of principles and best practices developed over generations of skilled workers and professionals has diminished. Ironically, at a time when
                        ...
                        <div className="accordion-item border-0 mb-2">
                            <h2 className="accordion-header">
                                <button className={`accordion-button ${open === 2 ? '' : "collapsed"} bg-light position-relative pe-3`} type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo" onClick={() => handleClick(2)}>
                                    Wash & Care
                                    <span className="bg-dark position-absolute end-0" style={{ width: "47px", height: "100%" }}></span>
                                </button>
                            </h2>
                            <div id="flush-collapseTwo" className={`accordion-collapse collapse ${open === 2 ? "show" : ""}`} data-bs-parent="#accordionFlushExample">
                        ...
                        <div className="accordion-item border-0">
                            <h2 className="accordion-header">
                                <button className={`accordion-button ${open === 3 ? '' : "collapsed"} bg-light position-relative pe-3`} type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree" onClick={() => handleClick(3)}>
                                    Reviews
                                    <span className="bg-dark position-absolute end-0" style={{ width: "47px", height: "100%" }}></span>
                                </button>
                            </h2>
                            <div id="flush-collapseThree" className={`accordion-collapse collapse ${open === 3 ? "show" : ""}`} data-bs-parent="#accordionFlushExample">
                                <div className="accordion-body mt-3">
                                    ...
                                    <div className="d-sm-flex align-items-center justify-content-between mb-4">
                                        ...
                                        <div className="d-flex mt-3 mt-sm-0">
                                            <Link href="#!" className="text-muted me-2 py-1 px-2 bg-light">Filter
                                                <span><Image src={icon} alt="" /></span></Link>
                                            <Link href="#!" className="text-muted py-1 px-2 bg-light">Short by:
                                                Latest
                                                <span><Image src={icon} alt="" /></span></Link>
                                        </div>
                                    </div>
                                                ...
                                                <CardBody>
                                                    <div className="rounded-pill d-inline-block align-items-center p-1 bg-light">
                                                        <div className="d-flex align-items-center">
                                                            <p className="mb-0 rounded-pill  bg-warning text-white d-inline-block text-center d-flex justify-content-center align-items-center" style={{ width: "14px", height: "100%" }}>P</p>
                                        ...
                                        <Col sm={6} md={4}>
                                            <Card>
                                                <CardBody>
                                                    <div className="rounded-pill d-inline-block align-items-center p-1 bg-light">
                                                        <div className="d-flex align-items-center">
                                                            <p className="mb-0 rounded-pill  bg-danger text-white d-inline-block text-center d-flex justify-content-center align-items-center" style={{ width: "14px", height: "100%" }}>K</p>
                                        ...
                                        <Col sm={6} md={4}>
                                            <Card>
                                                <CardBody>
                                                    <div className="rounded-pill d-inline-block align-items-center p-1 bg-light">
                                                        <div className="d-flex align-items-center">
                                                            <p className="mb-0 rounded-pill  bg-primary text-white d-inline-block text-center d-flex justify-content-center align-items-center" style={{ width: "14px", height: "100%" }}>G</p>
                                        ...
                                        <Col sm={6} md={4}>
                                            <Card>
                                                <CardBody>
                                                    <div className="rounded-pill d-inline-block align-items-center p-1 bg-light">
                                                        <div className="d-flex align-items-center">
                                                            <p className="mb-0 rounded-pill  bg-info text-white d-inline-block text-center d-flex justify-content-center align-items-center" style={{ width: "14px", height: "100%" }}>C</p>
                                        ...
                                        <Col sm={6} md={4}>
                                            <Card>
                                                <CardBody>
                                                    <div className="rounded-pill d-inline-block align-items-center p-1 bg-light">
                                                        <div className="d-flex align-items-center">
                                                            <p className="mb-0 rounded-pill  bg-warning text-white d-inline-block text-center d-flex justify-content-center align-items-center" style={{ width: "14px", height: "100%" }}>S</p>
                                        ...
                                        <Col sm={6} md={4}>
                                            <Card>
                                                <CardBody>
                                                    <div className="rounded-pill d-inline-block align-items-center p-1 bg-light">
                                                        <div className="d-flex align-items-center">
                                                            <p className="mb-0 rounded-pill  bg-danger text-white d-inline-block text-center d-flex justify-content-center align-items-center" style={{ width: "14px", height: "100%" }}>D</p>
