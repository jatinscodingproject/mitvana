...
import thumb1 from '@assets/images/single-product/sidebar-full-height/thumb-01.png'
import thumb2 from '@assets/images/single-product/sidebar-full-height/thumb-02.png'
import thumb3 from '@assets/images/single-product/sidebar-full-height/thumb-03.png'
import thumb4 from '@assets/images/single-product/sidebar-full-height/thumb-04.png'
                ...
                <div className="container">
                    <Row className="py-3">
                        ...
                        >
                            <div>
                                <div>
                                    <Swiper
                                        ...
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image src={thumb1} alt="" className="img-fluid w-100" priority />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                            ...
                                            <SwiperSlide>
                                                <Image src={thumb4} alt="" className="img-fluid w-100" priority />
                                            </SwiperSlide>
                                ...
                                <div className="mt-3">
                                    ...
                                    >
                                        <SwiperSlide>
                                            <Image src={thumb1} alt="" className="w-100 h-auto object-fit-contain" priority />
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <Image src={thumb2} alt="" className="w-100 h-auto object-fit-contain" priority />
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <Image src={thumb3} alt="" className="w-100 h-auto object-fit-contain" priority />
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <Image src={thumb4} alt="" className="w-100 h-auto object-fit-contain" priority />
                                        </SwiperSlide>
                                    </Swiper>
                                </div>
                            </div>
                        ...
                        <Col md={6} className="mt-5 mt-xl-0">
                            <h4 className="mb-3">Simple Skin T-shirt</h4>
                            <div className="d-flex flex-wrap justify-content-between">
                                <p className="text-muted fs-18 mb-4">$56.00</p>
