...
import thumb1 from '@assets/images/single-product/full-width-atc/thumb-01.jpg'
import thumb2 from '@assets/images/single-product/full-width-atc/thumb-02.jpg'
import thumb3 from '@assets/images/single-product/full-width-atc/thumb-03.jpg'
import thumbs1 from '@assets/images/single-product/layout-02/fbt_thumb-01.jpg'
                ...
                <Container>
                    <Row className="py-3 gx-xl-1">
                        ...
                        <Col md={6} className="mt-5 mt-md-0">
                            <h4 className="mb-3">Dusk Pom Beanie</h4>
                            ...
                            <div className="d-flex align-items-center gap-2 mt-4">
                                ...
                                <Button variant="teal" className="btn btn-teal w-75 text-uppercase rounded-pill min-w-150" onClick={handleShoppingShow}>
                                    Add to Cart
                                </Button>
                                        ...
                                        <ul className="list-unstyled m-0 p-0 d-flex flex-wrap align-items-center gap-2">
                                            <li className="d-inline-block">
                                                <Link href="/product-detail-layout-01">
                                                    <Image src={thumbs1} alt="" style={{ width: "115px", height: "147px", objectFit: "cover" }} />
                                                </Link>
                                            </li>
