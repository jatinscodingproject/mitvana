...
import { Row, Col, Nav, Tab, Modal, Card, CardBody } from 'react-bootstrap';
import Link from "next/link";
import Image from "next/image";
import thumbsticky from '@assets/images/single-product/layout-02/thumb-sticky.jpg'

const ProductDetailFullWidthAtcTab = () => {
                        ...
                        <Row className="nav tab_header justify-content-center">
                            <Col>
                                <Nav variant="pills" className="tab_header nav_tabs justify-content-center">
                                    ...
                                    <Nav.Item>
                                        <Nav.Link eventKey="Warrantyshipping" className="rounded-pill pill-border fw-medium custom-nav-link">Warranty & Shipping</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                            ...
                            <Col>
                                <Tab.Content className="mt-5">
                                    <Tab.Pane eventKey="Description">
                                        <Row className="pt-3">
                                            <Col lg={6} className="text-center text-muted">
                                                <h5 className="fw-semibold text-center mb-3 text-black">FIGHTING FIT</h5>
                                                <p>Go sporty this summer with this vintage navy and white striped v-neck t-shirt
                                                    from the
                                                    Abercrombie & Fitch. Perfect for pairing with denim and white kicks for a
                                                    stylish sporty
                                                    vibe. Will fit a UK 8-10, model shown is a UK 8 and 5’5. !!</p>
                                                <p>Typography is the work of typesetters, compositors, typographers, graphic
                                                    designers, art
                                                    directors, manga artists, comic book artists, graffiti artists, and now—anyone
                                                    who
                                                    ...
                                                    materials.</p>
                                                <p>
                                                    Hit your next boxing workout with a combination it’s never seen before in the
                                                    Combat
                                                    Drop Arm Tank, including a freedom-instilling regular fit and dropped armhole to
                                                    allow
                                                    you to throw jabs and hooks at the punching bag with ease. A lightweight
                                                    material keeps
                                                    you fighting fit, and fresh.
                                                </p>
                                            </Col>
                                            <Col lg={6}>
                                                <h5 className="fw-semibold text-center mb-3 text-black">FIND YOUR SIZE</h5>
                                                <table className="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col" className="bg-transparent bg-muted fw-medium">SIZE</th>
                                                            <th scope="col" className="bg-transparent bg-muted fw-medium">CHEST</th>
                                                            <th scope="col" className="bg-transparent bg-muted fw-medium">WAIST</th>
                                                            <th scope="col" className="bg-transparent bg-muted fw-medium">HIPS</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                            <th className="bg-transparent bg-muted fw-medium" scope="row">S</th>
                                                            <td className="bg-transparent bg-muted">39</td>
                                                            <td className="bg-transparent bg-muted">31</td>
                                                            <td className="bg-transparent bg-muted">35</td>
                                                        </tr>
                                                        <tr>
                                                            <th className="bg-transparent bg-muted fw-medium" scope="row">M</th>
                                                            <td className="bg-transparent bg-muted">41</td>
                                                            <td className="bg-transparent bg-muted">44</td>
                                                            <td className="bg-transparent bg-muted">37</td>
                                                        </tr>
                                                        <tr>
                                                            <th className="bg-transparent bg-muted fw-medium" scope="row">L</th>
                                                            <td className="bg-transparent bg-muted">43</td>
                                                            <td className="bg-transparent bg-muted">35</td>
                                                            <td className="bg-transparent bg-muted">39</td>
                                                        </tr>
                                                        <tr>
                                                            <th className="bg-transparent bg-muted fw-medium" scope="row">XL</th>
                                                            <td className="bg-transparent bg-muted">45</td>
                                                            <td className="bg-transparent bg-muted">37</td>
                                                            <td className="bg-transparent bg-muted">41</td>
                                                        </tr>
                                                        <tr>
                                                            <th className="bg-transparent bg-muted fw-medium" scope="row">XXL</th>
                                                            <td className="bg-transparent bg-muted">47</td>
                                                            <td className="bg-transparent bg-muted">39</td>
                                                            <td className="bg-transparent bg-muted">43</td>
                                                        </tr>
                                                    </tbody>
                                    ...
                                    <Tab.Pane eventKey="Warrantyshipping">
                                        ...
                                        <p className="mb-0">
                                            If issues experienced with the frame include a manufacturer&apos;s defect, or an issue resulting from
                                            an inherent flaw in the product, RAEN provides a 365 day warranty from the time of purchase. If
                                        ...
                                        <p className="mb-4">
                                            Scratched lenses and physical damage are not covered by warranty. Unfortunately we do not
                                            manufacture or sell replacement lenses.
                                        </p>
                                        <h6 className="fw-bold">Free FedEx 2-Day Shipping</h6>
                                        <p className="mb-4">
                                            Free FedEx 2-Day Shipping is available exclusively to the U.S. on orders over $150. FedEx 2-Day
                                        ...
                                        <p className="fst-italic fw-medium">*Free Shipping is not available with some promotions and other
                                            restrictions
                                            may apply.
                                        </p>
                                        ...
                                        <div className="d-sm-flex align-items-center justify-content-between mb-4">
                                            ...
                                            <div className="d-flex mt-3 mt-sm-0">
                                                <div className="dropdown review-dropdown">
                                                    <Link className="dropdown-toggle text-muted me-2" href="#!" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Filter </Link>
                                                    <ul className="dropdown-menu">
                                                        <li><Link className="dropdown-item" href="#!">ALL</Link></li>
                                                        <li><Link className="dropdown-item" href="#!">Excellent</Link></li>
                                                        <li><Link className="dropdown-item" href="#!">Very Good</Link></li>
                                                    </ul>
                                                </div>
                                                <div className="dropdown review-dropdown">
                                                    <Link className="dropdown-toggle text-muted" href="#!" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Short by: Latest </Link>
                                                    <ul className="dropdown-menu">
                                                        <li><Link className="dropdown-item" href="#!">Latest</Link></li>
                                                        <li><Link className="dropdown-item" href="#!">Oldest</Link></li>
                                                        <li><Link className="dropdown-item" href="#!">Images</Link></li>
                                                        <li><Link className="dropdown-item" href="#!">Most like</Link></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
...
export default ProductDetailFullWidthAtcTab