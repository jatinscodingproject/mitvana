...
import img1 from '@assets/images/single-product/icon-down.svg'
...
const DescriptionTab = () => {
    ...
    return (
        <React.Fragment>
            ...
            <div className="mt-4 mb-3 d-block">
                            ...
                            <div id="flush-collapseOne" className={`accordion-collapse collapse ${open === 1 ? "show" : ""}`} data-bs-parent="#accordionFlushExample">
                                <div className="accordion-body border border-top-0 border-light">
                                    ...
                                    <Row className="my-5 g-3">
                                        <Col md={6}>
                                            <Image src={thumb01} className="img-fluid" alt="" />
                                        </Col>
                                        <Col md={6}>
                                            <Image src={thumb02} className="img-fluid" alt="" />
                                        </Col>
                                    </Row>
                                </div>
                            </div>
                                ...
                                <div className="accordion-body">
                                            ...
                                            <button type="button" className="btn btn-warning py-1 px-2">
                                                <svg className="me-1" xmlns="http://www.w3.org/2000/svg" width="18.37" height="17.8" viewBox="0 0 21.682 21.602">
                                                    <g id="Symbol_32_2" data-name="Symbol 32 – 2" transform="translate(-961.98 -374.155)">
                                                        <path d="M0,0H4V11.2L1.937,14h0L0,11.2Z" transform="translate(979.891 381.756) rotate(40)" fill="none" stroke="#ffffff" strokeLinejoin="round" strokeWidth="1">
                                                        </path>
                                                        ...
                                                        <g transform="translate(981.126 380.964) rotate(40)" fill="none" stroke="#ffffff" strokeWidth="1">
                                                            ...
                                                            <rect x="0.5" y="0.5" width="2.128" height="0.4" fill="none">
                                                            </rect>
                                                        </g>
                                    ...
                                    <div className="d-sm-flex align-items-center justify-content-between mb-4">
                                        ...
                                        <div className="d-flex mt-3 mt-sm-0">
                                            <Link href="#!" className="text-muted me-2 py-1 px-2 sub-gray bg-light">Filter
                                                <span><Image src={img1} alt="" /></span></Link>
                                            <Link href="#!" className="text-muted py-1 px-2 bg-light">Short
                                                by:
                                                Latest
                                                <span><Image src={img1} alt="" /></span></Link>
                                        </div>
                                        ...
                                        <Col sm={6} md={4}>
                                            <Card>
                                                <CardBody className='mt-3'>
                                                    ...
                                                    <p className="text-muted mb-2">It is a long established fact that a reader
                                                        will
                                                        be
                                                        distracted
                                                        ...
                                                        <div className="d-flex align-items-center gap-1">
                                                            <svg fill="#878787" width="14" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.762 17.659" className="r--icon-dislike">
                                                                <g transform="translate(956.922 435.325) rotate(180)">
                                                                    ...
                                                                    <path d="M945.558,421.946v10.321l-2.9.261V421.777Z" transform="translate(-1 2.296)" className="cls-2">
                                                                    </path>
                                                                </g>
                                                            </svg>
