...
import thumb4 from '@assets/images/single-product/product-360/thumb-04.jpg'
import thumb5 from '@assets/images/single-product/product-360/thumb-05.jpg'
                ...
                <Container>
                    <Row className="py-3 gx-xl-1">
                            ...
                            <Row className="g-2">
                                ...
                                <Col xl={9} className=" mt-3 order-1 order-xl-2">
                                    <Swiper
                                        ...
                                        <div className="swiper-wrapper product-container">
                                            <div className="cursor"></div>
                                            <SwiperSlide>
                                                <Image className="mg-fluid w-100" src={thumb1} alt="product4" />
                                            </SwiperSlide>
                                            <SwiperSlide >
                                                <Image className="mg-fluid w-100" src={thumb2} alt="product5" />
                                            </SwiperSlide>
                                            <SwiperSlide className="product">
                                                <Image className="mg-fluid w-100" src={thumb3} alt="product31" />
                                            </SwiperSlide>
                                            <SwiperSlide className="product">
                                                <Image className="mg-fluid w-100" src={thumb4} alt="product42" />
                                            </SwiperSlide>
                                            <SwiperSlide className="product">
                                                <Image className="mg-fluid w-100" src={thumb5} alt="product43" />
                                            </SwiperSlide>
                        ...
                        <Col md={6} className="mt-5 mt-md-0">
                            <h4 className="mb-3">City Backpack Black</h4>
                            <div className="d-flex flex-wrap justify-content-between">
                                <p className="text-muted fs-18 mb-4">$55.00</p>
