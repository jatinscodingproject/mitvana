                                ...
                                <Col xl={9} className="mt-3 order-1 order-xl-2">
                                    <Swiper
                                        ...
                                        <div className="swiper-wrapper">
                                            <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={product4} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={product5} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={product31} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={product42} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={product43} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={product32} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={product44} alt="" />
                                                </SwiperSlide>
                                            </div>
                        ...
                        <Col md={6} className="mt-5 mt-md-0">
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="form-check mx-2">
                                        <input
                                            ...
                                            onChange={handleSizeChange}
                                        />
                                        <label className="form-check-label" htmlFor="flexRadioDefault2">M</label>
                                    </div>
                                    <div className="form-check">
                                        <input
                                            className="form-check-input product-radio"
                                            ...
                                            onChange={handleSizeChange}
                                        />
                                        <label className="form-check-label" htmlFor="flexRadioDefault3">L</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="d-flex flex-wrap align-items-center gap-2 mt-4">
                                ...
                                <div className="product_wishlist square-40 rounded-circle border border-dark bg-transparent text-center" style={{ lineHeight: '40px' }}>
                                    <a href="#"><i className="facl facl-heart-o"></i></a>
                                </div>
                            </div>
                            ...
                            <div className="mt-4 d-flex gap-3 text-nowrap flex-wrap row-gap-1">
                                <a href="#sizeGuidModal" className="text-black fw-semibold" onClick={handleShow}>Size Guide</a>
                                <a href="#deliveyReturnModal" className="text-black fw-semibold mx-2" onClick={handleShow2}>Delivery and Return</a>
                                <a href="#askQuesitionModal" className="text-black fw-semibold" onClick={handleShow3}>Ask a Question</a>
                            </div>
                            ...
                            <div className="mt-4">
                                ...
                                <p className="mb-2">
                                    ...
                                    <span className="text-muted">
                                        <a href="#!" className="text-muted"> All, </a>
                                        <a href="#!" className="text-muted">Best seller, </a>
                                        <a href="#!" className="text-muted">Bottom, </a>
                                        <a href="#!" className="text-muted">Dress, </a>
                                        <a href="#!" className="text-muted">New Arrival, </a>
                                        <a href="#!" className="text-muted">Women</a>
                                    </span>
                                </p>
                                <p className="mb-0">
                                    <span>Tag :</span>
                                    <span className="text-muted">
                                        ...
                                        <a href="#!" className="text-muted">Girl, </a>
                                        <a href="#!" className="text-muted">Swim, </a>
                                        <a href="#!" className="text-muted">Clothing, </a>
                                        <a href="#!" className="text-muted">Summer</a>
                                    </span>
                                </p>
                            </div>
