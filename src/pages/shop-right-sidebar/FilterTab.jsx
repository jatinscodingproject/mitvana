...
import ProductCategories from '@pages/shop-left-sidebar/ProductCategories';
import PriceFilter from '@pages/shop-left-sidebar/PriceFilter';
import ColorFilter from '@pages/shop-left-sidebar/ColorFilter';
import SizeFilter from '@pages/shop-left-sidebar/SizeFilter';
        ...
        <React.Fragment>
            ...
            <Container>
                ...
                <Row>
                    ...
                    <Col lg={3} className="col-lg-3 d-none d-lg-block filter-box border-0" style={{ boxShadow: "none" }}>
                        <ProductCategories />
                        <PriceFilter />
                        <ColorFilter />
                        <SizeFilter />
