...
import size1 from '@assets/images/single-product/advance-product-type/full-size-01.jpg'
import size2 from '@assets/images/single-product/advance-product-type/full-size-02.jpg'
import size3 from '@assets/images/single-product/advance-product-type/full-size-03.jpg'
import size4 from '@assets/images/single-product/advance-product-type/full-size-04.jpg'
import advanceProduct1 from '@assets/images/single-product/advance-product-type/advance-type-01.jpg'
import advanceProduct3 from '@assets/images/single-product/advance-product-type/advance-type-03.jpg'
import advanceProduct5 from '@assets/images/single-product/advance-product-type/advance-type-05.jpg'
        ...
        <React.Fragment>
            <section className="py-4">
                <div className="container">
                    <div className="row py-3 gx-xl-1">
                            ...
                            <Row className='g-2'>
                                <Col xl={2} className="mt-xl-3 mt-2 order-2 order-xl-1">
                                    ...
                                    >
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image src={size1} className="object-fit-cover" alt="product1" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={size2} className="object-fit-cover" alt="product5" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={size3} className="object-fit-cover" alt="product5" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={size4} className="object-fit-cover" alt="product42" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={size2} className="object-fit-cover" alt="product43" />
                                            </SwiperSlide>
                                        </div>
                                    </Swiper>
                                </Col>
                                <Col xl={9} className="mt-3 order-1 order-xl-2">
                                    <Swiper
                                        ...
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image className="img-fluid w-100" src={size1} alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image className="img-fluid w-100" src={size2} alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image className="img-fluid w-100" src={size3} alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image className="img-fluid w-100" src={size4} alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image className="img-fluid w-100" src={size2} alt="" />
                                            </SwiperSlide>
                        ...
                        <Col md={6} className="mt-5 mt-md-0">
                            ...
                            <h6 className="text-uppercase fw-bold mt-3">CHOOSE STYLE:</h6>

                            <Row>
                                <Col sm={8}>
                                    <Row className="g-2">
                                        <div className="col-4">
                                            <div className="p-1 product-advance-card rounded">
                                                <Image src={advanceProduct1} className="img-fluid w-100" style={{ height: "120px" }} alt="" />
                                                <p className="text-black text-center my-1">Tank</p>
                                            </div>
                                        </div>
                                        <div className="col-4">
                                            <div className="p-1 product-advance-card advance-card1 rounded">
                                                <Image src={advanceProduct3} className="img-fluid w-100" style={{ height: "120px" }} alt="" />
                                                <p className="text-black text-center my-1">Hoodie</p>
                                            </div>
                                        </div>
                                        <div className="col-4">
                                            <div className="p-1 product-advance-card advance-card1 rounded">
                                                <Image src={advanceProduct5} className="img-fluid w-100" style={{ height: "120px" }} alt="" />
                                                <p className="text-black text-center my-1">Long Sleeve</p>
                                            </div>
                                        </div>
                                    </Row>
                                </Col>
                            ...
                            <div className="pt-2">
                                ...
                                <div className="product-color-list size mt-2 gap-2 d-flex align-items-center">
                                    <Link
                                        href="#!"
                                        className={`d-inline-block rounded-circle px-4 square-xs d-flex align-items-center justify-content-center ${color === 'blue' ? 'active' : ''}`}
                                        onClick={(e) => { e.preventDefault(); setColor('blue'); }}
                                    ...
                                    <Link
                                        href="#!"
                                        className={`d-inline-block rounded-circle px-4 square-xs d-flex align-items-center justify-content-center ${color === 'white' ? 'active' : ''}`}
                                        onClick={(e) => { e.preventDefault(); setColor('white'); }}
                                        style={{ borderRadius: '30px!important' }}
                                    >
                                        White
                                    </Link>
                                    <Link
                                        href="#!"
                                        className={`d-inline-block rounded-circle px-4 square-xs d-flex align-items-center justify-content-center ${color === 'black' ? 'active' : ''}`}
                                        onClick={(e) => { e.preventDefault(); setColor('black'); }}
                                        // style={{ borderRadius: '30px!important' }}
