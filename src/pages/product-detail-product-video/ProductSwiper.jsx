...
import thumb01 from '@assets/images/single-product/product-video/thumb-01.jpg'
import thumb02 from '@assets/images/single-product/product-video/thumb-02.jpg'
import thumb03 from '@assets/images/single-product/product-video/thumb-03.jpg'
import cat01 from '@assets/images/shop/collection-list/cat-01.jpg'
                ...
                <Container>
                    <Row className="py-3 gx-xl-1">
                                ...
                                <Col xl={2} className="mt-xl-3 mt-2 order-2 order-xl-1">
                                    ...
                                    >
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image src={thumb01} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={thumb02} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <i className="las la-play"></i>
                                                <Image src={thumb03} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <i className="lab la-youtube"></i>
                                                <Image src={cat01} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                        </div>
                                    </Swiper>
                                </Col>
                                ...
                                <Col xl={9} className="mt-3 order-1 order-xl-2">
                                    <Swiper
                                        ...
                                        <div className="swiper-wrapper">
                                            <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image className="drift-demo-trigger img-fluid w-100" src={thumb01} alt="product4" />
                                            </SwiperSlide>
                                            <SwiperSlide className="product">
                                                <Image className="drift-demo-trigger img-fluid w-100" src={thumb02} alt="product5" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <video controls autoPlay={false} loop style={{ width: "100%" }} id="videoPlayer">
                                                    {/* <source src="http://localhost:3000/assets/images/video.mp4" type="video/mp4" /> */}
                                                    <source src="/assets/videos/video.mp4" type="video/mp4" />
                                                </video>
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <div className="iframe-container" style={{ width: "100%", height: "500px" }}>
                                                    <iframe width="560" src="https://www.youtube.com/embed/X4t0JxiBeO0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" loading="lazy" allowFullScreen={true}></iframe>
                                                </div>
                                            </SwiperSlide>
                                            </div>
                        ...
                        <Col md={6} className="mt-5 mt-md-0">
                            <h4 className="mb-3">Jersey Puff Sleeve</h4>
                            ...
                            <div className="pt-2 mb-4 pb-3">
                                <h6 className="text-uppercase fw-bold my-3">
                                    Size: <span>{size}</span>
                                </h6>
