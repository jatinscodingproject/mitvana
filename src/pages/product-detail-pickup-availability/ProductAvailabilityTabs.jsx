...
const ProductAvailabilityTabs = () => {
    ...
    return (
        <React.Fragment>
            <div className="mt-4 mb-5 py-5 bg-light d-none d-xl-block">
                        ...
                        <Tab.Content className="mt-4">
                            <Tab.Pane eventKey="Description">
                                <p className="text-muted">
                                    ...
                                    streets or rushing to make it to the front of a music gig, these orange suede gazelle handball
                                    Spezial sneakers from Adidas are the perfect footwear to accompany an active lifestyle. Keep on
                                    moving. Featuring stitched panels, a signature three stripe detail, a logo patch at the tongue,
                                    a branded insole, a contrasting heel counter, a rubber sole and a logo to the outside.
                                    POSITIVELY CONSCIOUS: Adidas Group scores 4 out 5 by independent ethical brand rating agency
                                    Good On You.</p>
                                <p className="text-muted">
                                    It uses eco-friendly materials in many products - 100% of its cotton is from sustainable sources
                                    and it&apos;s committed to use 100% recycled polyester by 2024. It traces and audits almost all of
                                    its supply chain to ensure good labor standards, and has committed to reducing carbon and water
                                    stress across its whole supplier base.
                                </p>
                                <h5 className="mt-4 mb-3">Composition</h5>
                                <ul className="list-unstyled">
                                    <li className="pb-3 text-muted">Outer: Suede 100%</li>
                                    <li className="pb-3 text-muted">Lining: Polyamide 100%</li>
                                    <li className="pb-3 text-muted">Sole: Rubber 100%</li>
                                    <li className="pb-3 text-muted">Designer Style ID: EE5730</li>
                                </ul>
                                <h5 className="mt-4 mb-3">Wearing</h5>
                                <ul className="list-unstyled">
                                    <li className="text-muted">Model is 1.85 m wearing size 10 (UK)</li>
                                </ul>
                            </Tab.Pane>
...
export default ProductAvailabilityTabs