...
import trust1 from "@assets/images/single-product/trust_img2.png"
import Image from 'next/image'

const ShippingandDelivery = ({ handleShoppingShow }) => {
    ...
    return (
        <React.Fragment>
            <Col lg={6} className="mt-5 mt-xl-0">
                <h4 className="mb-3">Adidas Copa Primeknit Sneakers</h4>
                <div className="d-flex justify-content-between">
                    <p className="text-muted fs-18 mb-4">$289.00</p>
                    <div id="#tab_reviews_product" className="rating_sp_kl dib">
                ...
                <p className="text-muted">
                    Orange you glad to be standing fit and healthy on your feet? Whether skateboarding on the
                    streets or rushing to make it to the front of a music gig, these orange...
                </p>
                <div className="d-flex flex-wrap align-items-center gap-2 mt-4">
                    ...
                    <button
                        className={`btn btn-danger-dark text-uppercase rounded-pill min-w-150 ${shake ? 'animation-shake' : ''}`}
                        data-bs-toggle="offcanvas"
                        data-bs-target="#shoppingCartOffcanvas"
                ...
                <div className="mt-4">
                    <Image src={trust1} alt="" className="img-fluid" />
                </div>

                <div className="mt-4 d-flex gap-3 text-nowrap flex-wrap row-gap-1">
                    <Link href="#sizeGuidModal" data-bs-toggle="modal" className="text-black fw-semibold">Size Guide</Link>
                    <Link href="#deliveyReturnModal" data-bs-toggle="modal" className="text-black fw-semibold mx-2">Delivery and Return</Link>
                    <Link href="#askQuesitionModal" data-bs-toggle="modal" className="text-black fw-semibold">Ask a
                        Question</Link>
                </div>
                <div className="mt-4">
                ...
                <div className="text-black fs-12 d-flex mt-5">
                    <i className="las la-truck fading_true fs__20 mr__5 mt-1 fs-16"></i>
                    <p className="ms-1">Order in the next 15 hours 13 minutes to get it between <span className="fw-medium border-bottom">Friday, 29th January and
                        Wednesday,
                        3rd February</span></p>
                </div>
                <div className="text-black fs-12 d-flex">
                    <i className="cd mr__5 fading_true fs__20 las la-eye mt-1 fs-16"></i>
                    <p className="ms-1"><span className="fw-medium border-bottom">85 People </span> are viewing this right
                        now</p>
                </div>
            </Col>
        </React.Fragment >
