...
const FilterTab = () => {
    ...
    return (
        <React.Fragment>
            <div className=" mt-5 d-flex justify-content-between align-items-center">
                ...
                <ul className="nav tab_header tab_filter gap-2 justify-content-end justify-content-sm-center" id="pills-tab" role="tablist">
                    <li className="nav-item d-sm-none" role="presentation">
                        <button className="nav-link" id="best-pan1-tab" data-bs-toggle="pill" data-bs-target="#best-pan1" type="button" role="tab" aria-controls="best-pan1" aria-selected="true">
            ...
            <div className="tab-content my-3 my-md-5" id="pills-tabContent">
