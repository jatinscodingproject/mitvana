...
import product1 from "@assets/images/single-product/pre-orders/thumb-01.jpg"
import product2 from "@assets/images/single-product/pre-orders/thumb-02.jpg"
import product3 from "@assets/images/single-product/pre-orders/thumb-03.jpg"
                                ...
                                <Tab.Content className="mt-5">
                                    <Tab.Pane eventKey="Description">
                                        ...
                                        <Row className="my-5 g-3">
                                            ...
                                            <Col md={4}>
                                                <Image src={product3} className="img-fluid" alt="" />
                                            </Col>
                                            <Col md={4}>
