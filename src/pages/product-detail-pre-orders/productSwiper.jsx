...
import product4 from "@assets/images/single-product/pre-orders/thumb-04.jpg"
import product5 from "@assets/images/single-product/pre-orders/thumb-05.jpg"
            ...
            <Container className='py-4'>
                <Row className='py-3 gx-xl-1'>
                    ...
                    <Col md={6} className='mt-5 mt-md-0'>
                        <h4 className="mb-3">Ribbed Stripe Top</h4>
                        ...
                        <div className="mt-4 d-flex gap-3 text-nowrap flex-wrap row-gap-1">
                            ...
                            <Link href="#deliveyReturnModal" data-bs-toggle="modal" className="text-black fw-semibold mx-2" onClick={handleShow}>Delivery and Return</Link>
                            <Link href="#askQuesitionModal" data-bs-toggle="modal" className="text-black fw-semibold" onClick={handleShow}>Ask a
                                Question</Link>
                        </div>
                        <div className="mt-4">
