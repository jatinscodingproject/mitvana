...
import product01 from '@assets/images/single-product/layout-02/full-size-01.jpg'
import product02 from '@assets/images/single-product/layout-02/full-size-02.jpg'
import product03 from '@assets/images/single-product/layout-02/full-size-03.jpg'
import product04 from '@assets/images/single-product/layout-02/full-size-04.jpg'
import fbtThumb2 from '@assets/images/products/fbt_thumb-02.jpg'
import fbtThumb3 from '@assets/images/products/fbt_thumb-03.jpg'
import fbtThumb4 from '@assets/images/products/fbt_thumb-04.jpg'
                ...
                <Container>
                    <Row className="py-3 gx-xl-1">
                                ...
                                <Col xl={2} className="mt-xl-3 mt-2 order-2 order-xl-1">
                                    ...
                                    >
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <Image src={product01} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product02} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product03} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product04} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <Image src={product02} className="object-fit-cover" alt="" />
                                            </SwiperSlide>
                                ...
                                <Col xl={9} className="mt-3 order-1 order-xl-2">
                                    <Swiper
                                        ...
                                        <div className="swiper-wrapper">
                                            <div className="swiper-wrapper">
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={product01} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={product02} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={product03} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={product04} alt="" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <Image className="img-fluid w-100" src={product02} alt="" />
                                                </SwiperSlide>
                        ...
                        <Col md={6} className="mt-5 mt-md-0">
                            <h4 className="mb-3">Striped Long Sleeve Top</h4>
                            <div className="d-flex flex-wrap justify-content-between">
                                <p className="text-muted fs-18 mb-4"><span className="text-decoration-line-through me-2">$45.00</span>
                                        ...
                                        <ul className="list-unstyled m-0 p-0 d-flex flex-wrap align-items-center gap-2">
                                            <li className="d-inline-block">
                                                <Link href="/product-detail-layout-01">
                                                    <Image src={product01} alt="" style={{ width: "115px", height: "147px", objectFit: "cover" }} />
                                                </Link>
                                            </li>
                                            ...
                                            <li className="d-inline-block">
                                                <Link href="/product-detail-layout-01">
                                                    <Image src={fbtThumb2} alt="" style={{ width: "115px", height: "147px", objectFit: "cover" }} />
                                                </Link>
                                            </li>
                                            <li className="d-inline-block fs-4 text-muted">
                                                +
                                            ...
                                            <li className="d-inline-block">
                                                <Link href="/product-detail-layout-01">
                                                    <Image src={fbtThumb3} alt="" style={{ width: "115px", height: "147px", objectFit: "cover" }} />
                                                </Link>
                                            </li>
                                            <li className="d-inline-block fs-4 text-muted">
                                                +
                                            ...
                                            <li className="d-inline-block">
                                                <Link href="/product-detail-layout-01">
                                                    <Image src={fbtThumb4} alt="" style={{ width: "115px", height: "147px", objectFit: "cover" }} />
                                                </Link>
                                            </li>
                                        </ul>
                                    </Col>
                                        ...
                                        <ul className="list-unstyled m-0 p-0 vstack gap-3">
                                            <li className="d-flex flex-wrap align-items-center">
                                                ...
                                                <span className="text-muted"><strong>This item:</strong> Striped Long Sleeve
                                                    Top</span>
                                                <select className="form-select w-auto d-inline-block ps-2 pe-4 py-1 mx-2 rounded-1" style={{ backgroundPosition: "right .5rem center", backgroundSize: "12px 10px" }}>
                                                    <option value="black-s" defaultValue="Black">Black / S</option>
                                            ...
                                            <li className="d-flex flex-wrap align-items-center">
                                                ...
                                                <select className="form-select product-form-select w-auto d-inline-block ps-2 pe-4 py-1 mx-2 rounded-1"
                                                    style={{ backgroundPosition: "right .5rem center", backgroundSize: "12px 10px" }}
                                                >
