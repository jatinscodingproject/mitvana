...
const DescriptionTab = () => {
    ...
    useEffect(() => {
        if (typeof window !== 'undefined') {
            ...
            flickityRef.current = new FlickityClass('.tab-slideshow', {
                imagesLoaded: false,
    ...
    const reviewClose = () => setReview(false);
    const reviewShow = () => setReview(true);
        ...
        <React.Fragment>
            <div className="mt-4 mb-5 py-5 d-none d-lg-block main-project-section ">
                <div className="container">
                    <Tab.Container id="left-tabs-example mt-5" defaultActiveKey="first" activeKey={activeKey} onSelect={(k) => setActiveKey(k)}>
                        ...
                        <Tab.Content className="mt-5">
                            <Tab.Pane eventKey="Description">
                                ...
                                <div className="row justify-content-center mt-5">
                                    <div className="col-lg-7">
                                        <div className="text-center">
                                            <div className="mb-2">
                                                <h3 className="shop-title shop-title-light position-relative w-100 text-center">
                                                    <span className="bg-light px-3 ">Shop The Look</span>
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <Row className="mt-4 my-sm-4 pt-2 py-sm-2 tab-slideshow">
                    ...
                    <Modal show={review} onHide={reviewClose} centered>
                        <Modal.Body className="p-4">
                            <Link href="#!" data-bs-dismiss="modal" className="fs-35 close position-absolute top-0 end-0" aria-label="Close" onClick={reviewClose}>
