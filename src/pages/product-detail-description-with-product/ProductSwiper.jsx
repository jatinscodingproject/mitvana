...
import product1 from "@assets/images/single-product/description-with-product/thumb-01.jpg"
import product2 from "@assets/images/single-product/description-with-product/thumb-02.jpg"
import product3 from "@assets/images/single-product/description-with-product/thumb-03.jpg"
import product4 from "@assets/images/single-product/description-with-product/thumb-04.jpg"
            ...
            <Container className='py-4'>
                <Row className='py-3 gx-xl-1'>
                    ...
                    <Col md={6} className='mt-5 mt-md-0'>
                        <h4 className="mb-3">Ridley High Waist</h4>
                        <div className="d-flex flex-wrap justify-content-between">
                            <p className="text-muted fs-18 mb-4">$36.00</p>
