  ...
  return (
    <React.Fragment>
      ...
      <div className="mt-4 custom-bg px-5 py-3 custom-text px-md-10">
        ...
        <p className="work-sans fs-5 text-center">Home / Terms of Service</p>
      </div>
      <section
            ...
            <div class="elementor-widget-wrap elementor-element-populated">
              ...
              >
                <div class="elementor-widget-container">
                  <p>OVERVIEW</p> <br />
                  <p>
                    <span style={{ fontWeight: 400 }}>This website : </span>
                    <span style={{ fontWeight: 400 }}>www.mitvana.com</span>
                    <span style={{ fontWeight: 400 }}>
                      {" "}
                      &nbsp;is operated by Matxin Labs Private Limited.
                      Throughout the site, the terms “we”, “us” and “our” refer
                      to Matxin Labs Private Limited. Matxin Labs Private
                      limited &nbsp;offers this website, including all
                  ...
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      ...
                      of the site, including without limitation users who are
                  ...
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      ...
                      for changes. Your continued use of or access to the
                  ...
                  <p><br />
                    <span style={{ fontWeight: 400 }}>
                      ...
                      in your state or province of residence and you have given
                      us your consent to allow any of your minor dependents to
                      use this site.
                    </span><br />
                  </p>
                  <p>
                  ...
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      ...
                      an immediate termination of your Services. <br /><br />
                    </span>
                  </p>
                  <p>
                  ...
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      ...
                      connecting networks or devices. Credit card information is
                  ...
                  <p>
                    <b>ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</b>
                  </p><br />
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      We are not responsible if information made available on
                      this site is not accurate, complete or current. The
                      material on this site is provided for general information
                      only and should not be relied upon or used as the sole
                      basis for making decisions without consulting primary,
                      more accurate, more complete or more timely sources of
                      information. Any reliance on the material on this site is
                      at your own risk.
                    </span>
                  </p>
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      ...
                      no obligation to update any information on our site. You
                  ...
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      ...
                      possible the colours and images of our products that
                  ...
                  <p>
                    For orders containing multiple products, delivery may occur
                    in separate shipments. Typically, delivery takes 5-7
                    business days from the date the order is placed. Once your
                    order is confirmed, you can view the estimated shipping and
                    delivery timeline on the order details page. Please note
                    that these estimated delivery times are indicative, and
                    delays beyond our control may occur.
                  </p>
                  <p>
                    If the company is unable to deliver your order within the
                    estimated timeframe for any reason, you will be notified via
                    email, outlining the cause of the delay. You will then have
                    the option to either cancel the order or wait for the
                    product to be delivered.
                  </p>
                  <p><br />
                    Please be aware that your order may be canceled in the
                    following cases:{" "}
                  </p><br />
                  <ol>
                    <li>The ordered product is unavailable.</li>
                    <li>
                      At your request, if the product cannot be delivered within
                      the expected time frame due to delays from our delivery
                      partners.
                    </li>
                  </ol>
                  <p>
                    The company will not be held liable for any direct or
                    indirect damage or loss resulting from order cancellations
                    or delivery delays.
                  </p>
                  <p>&nbsp;</p>
                  <p>
                    <b>BILLING AND ACCOUNT INFORMATION</b>
                  </p><br />
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      ...
                      address. In the event that we make a change to or cancel
                      an order, we may attempt to notify you by contacting the
                      e-mail and/or billing address/phone number provided at the
                      time the order was made. We reserve the right to limit or
                  ...
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      ...
                      from or relating to your use of optional third-party
                      tools.
                    </span>
                  </p>
                  <p>
                  ...
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      ...
                      shall be under no obligation (1) to maintain any comments
                      in confidence; (2) to pay compensation for any comments;
                  ...
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      ...
                      that could in any way affect the operation of the Service
                      or any related website. You may not use a false e-mail
                  ...
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      ...
                      applied in the Service or on any related website, should
                      be taken to indicate that all information in the Service
                  ...
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      ...
                      or its content: (a) for any unlawful purpose; (b) to
                      ...
                      or operation of the Service or of any related website,
                      other websites, or the Internet; (h) to collect or track
                      the personal information of others; (i) to spam, phish,
                      pretext, spider, crawl, or scrape; (j) for any obscene or
                      immoral purpose; or (k) to interfere with or circumvent
                      the security features of the Service or any related
                  ...
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      ...
                      for indefinite periods of time or cancel the service at
                  ...
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      ...
                      are (except as expressly stated by us) provided ‘as is’
                      and ‘as available’ for your use, without any
                  ...
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      In no case shall Matxin Labs&nbsp;Private Limted, our
                      ...
                      any of the service or any products procured using the
                  ...
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      Only in case of any liability arising out of the usage of
                      the product(s) bought from the website belonging to Matxin
                      Labs Private Limited our liability will be limited to the
                  ...
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      You agree to indemnify, defend and hold harmless Matxin
                      Labs Private Limited and our parent, subsidiaries,
                  ...
                  <p>
                    <span style={{ fontWeight: 400 }}>
                      ...
                      at{" "}
                      <a href="mailto:info@mitvanastores.com">
                        info@mitvanastores.com
                      </a>
                    </span>
                  </p>{" "}
                </div>
