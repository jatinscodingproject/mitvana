...
import thumb2 from '@assets/images/single-product/without-thumbnail/thumb-02.jpg'
import thumbsticky from '@assets/images/single-product/layout-02/thumb-sticky.jpg'
import Link from "next/link";

const ProductDetailWithoutThumbnailTab = () => {
                            ...
                            <Col>
                                <Tab.Content className="mt-5">
                                    <Tab.Pane eventKey="Description">
                                        <div className="container">
                                            <Row className="equal_nt nt_contain">
                                                <Col md={4}>
                                                    <h5 className="fw-semibold">Premium Materials</h5>
                                                    <p>Blandit parturient adipiscing faucibus fringilla vestibulum ultrices integer
                                                        dolor parturient parturient at porta platea inceptos. Habitant dui ut fringilla
                                                        eleifend tincidunt scelerisque porta a tortor adipiscing ullamcorper
                                                        etiam imperdiet pulvinar vel facilisis potenti facilisis mi parturient sed per
                                                        egestas vivamus a auctor eu curae. Id dui bibendum non enim accumsan leo habitant
                                                        diam eu.
                                                    </p>
                                                    <h5 className="fw-semibold">Layered Design<span className="title-separator"><span></span></span>
                                                    </h5>
                                                    <ul className="p-0 ps-3 mb-0">
                                                        ...
                                                        <li>Proin a taciti adipiscing tempor turpis.</li>
                                                        <li>Mi netus eros nisi vulputate etiam.</li>
                                                        <li>Massa mi suspendisse ligula vestibu.</li>
                                                    </ul>
                                                </Col>
                                                <Col md={4}>
                                                    <div>
                                                        <Image src={thumb1} alt="" className="img-fluid" priority />
                                                    </div>
                                                </Col>
                                                <Col md={4} >
                                                    <div>
                                                        <Image src={thumb2} alt="" className="img-fluid" priority />
                                                    </div>
                                                </Col>
                                            </Row>
                                        </div>
...
export default ProductDetailWithoutThumbnailTab