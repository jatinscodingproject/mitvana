                                    ...
                                    <div className="container">
                                        <Row className="equal_nt nt_contain">
                                            <Col lg={4} className="mb-3 mb-lg-0">
                                                ...
                                                <p>Blandit parturient adipiscing faucibus fringilla vestibulum ultrices
                                                    integer dolor parturient parturient at porta platea inceptos. Habitant dui
                                                    ut fringilla eleifend tincidunt scelerisque porta a tortor adipiscing
                                                    ullamcorper
                                                    etiam imperdiet pulvinar vel facilisis potenti facilisis mi parturient sed
                                                    per egestas vivamus a auctor eu curae. Id dui bibendum non enim accumsan leo
                                                    habitant diam eu.
                                                </p>
                                                <h5 className="fw-semibold">Layered Design<span className="title-separator"><span></span></span></h5>
                                            ...
                                            <Col md={4} className="mb-3 mb-md-0">
                                                <div>
                                                    <Image src={thumb1} alt="" className="img-fluid" />
                                                </div>
                                            </Col>
                                            <Col md={4}>
                                                <div>
                                                    <Image src={thumb2} alt="" className="img-fluid" />
                                                </div>
                                            </Col>
                                        </Row>
                                    </div>
