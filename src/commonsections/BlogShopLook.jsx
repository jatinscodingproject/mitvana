...
const BlogShopLook = () => {
    ...
    useEffect(() => {
        if (typeof window !== 'undefined') {
            ...
            flickityRef.current = new FlickityClass('.show-slideshow', {
                imagesLoaded: false,
    ...
    return (
        <React.Fragment>
            <h3 className="shop-title position-relative w-100 text-center mb-5 mt-2">
                <span className="bg-white px-3">Shop The Look</span>
            </h3>


            <Row className="my-4 py-2 show-slideshow">
