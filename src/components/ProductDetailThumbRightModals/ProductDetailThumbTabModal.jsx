...
const HairMoadl = ({ modalShow1, handleRightModal1Close }) => {
...
const FashionModal = ({ modalShow2, handleRightModal2Close }) => {
...
const ProductInfoModal = ({ modalShow3, handleRightModal3Close }) => {
    return (
...
const ProductHoverModal = ({ modalShow4, handleRightModal4Close }) => {
...
const FashionModall = ({ modalShow5, handleRightModal5Close }) => {
...
const SortModal = ({ modalShow6, handleRightModal6Close }) => {
    const [isHovered4, setIsHovered4] = useState(false);
...
const CapModal = ({ modalShow7, handleRightModal7Close }) => {
...
const WatchModal = ({ modalShow10, handleRightModal10Close }) => {
...
const ProductInfoModal2 = ({ modalShow8, handleRightModal8Close }) => {
    return (
...
const ProductInfoModal3 = ({ modalShow9, handleRightModal9Close }) => {
    return (
