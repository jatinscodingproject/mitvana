                ...
                <div className="mt-3">
                    ...
                    {slide.colors ?
                        <div className="product-color-list mt-2 gap-2 d-flex align-items-center">
                            {slide.colors && slide.colors.map((color, index) => (
                                <Link
                                    key={index}
                                    href="#!"
                                    onClick={(e) => {
                        ...
                        <div className="product-color-list mt-2 gap-2 d-flex align-items-center">
                            ...
                            {slide.color && slide.color.map((color, index) => {
                                return (
                                    <Link
                                        href="#!"
                                        key={index}
