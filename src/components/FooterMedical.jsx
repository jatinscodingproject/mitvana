                                ...
                                <div className="mt-md-4 pt-md-2">
                                    <ul className="menu list-unstyled">
                                        <li className="menu-item">
                                            <Link href="shop-filter-sidebar.html" className="text-muted">Men</Link>
                                        </li>
                                        <li className="menu-item">
                                            <Link href="shop-filter-sidebar.html" className="text-muted">Women</Link>
                                        </li>
                                        <li className="menu-item">
                                            <Link href="shop-1600px-layout.html" className="text-muted">Accessories</Link>
                                        </li>
                                        <li className="menu-item">
                                            <Link href="shop-1600px-layout.html" className="text-muted">Shoes</Link>
                                        </li>
                                        <li className="menu-item">
                                            <Link href="shop-1600px-layout.html" className="text-muted">Denim</Link>
                                        </li>
                                        <li className="menu-item">
                                            <Link href="shop-1600px-layout.html" className="text-muted">Dress</Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            <ul id="footer-menu" className="mt-2 mt-lg-0 list-unstyled d-flex align-items-center mb-0 justify-content-lg-end justify-content-center flex-wrap">
                                <li className="menu-item ">
                                    <Link href="shop-filter-sidebar.html" className="text-muted mx-2">Shop</Link>
                                </li>
                                <li className="menu-item ">
