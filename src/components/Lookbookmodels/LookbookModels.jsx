...
const PinModal1 = ({ show, handleClose }) => {
...
const PinModal2 = ({ show, handleClose }) => {
    const [isHovered, setIsHovered] = useState(false);
    const [showw, setShoww] = useState(false);
    const [cardShow, setCardShoww] = useState(false);
    const handleModelClose = () => setShoww(false);
...
const PinModal3 = ({ show, handleClose }) => {
    const [isHovered, setIsHovered] = useState(false);
    const [showw, setShoww] = useState(false);
    const [cardShow, setCardShoww] = useState(false);
    const handleModelClose = () => setShoww(false);
...
const PinModal4 = ({ show, handleClose }) => {
    const [isHovered, setIsHovered] = useState(false);
    const [showw, setShoww] = useState(false);
    const [cardShow, setCardShoww] = useState(false);
    const handleModelClose = () => setShoww(false);
...
const PinModal5 = ({ show, handleClose }) => {
    const [isHovered, setIsHovered] = useState(false);
    const [showw, setShoww] = useState(false);
    const [cardShow, setCardShoww] = useState(false);
    const handleModelClose = () => setShoww(false);
...
const PinModal6 = ({ show, handleClose }) => {
    const [isHovered, setIsHovered] = useState(false);
    const [showw, setShoww] = useState(false);
    const [cardShow, setCardShoww] = useState(false);
    const handleModelClose = () => setShoww(false);
