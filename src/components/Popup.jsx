...
const PopupPage = () => {
    ...
    const stopAutohide = useRef(null);
    ...
    const hideWindow = useCallback(() => {
        ...
        if (popMain) {
            popMain.style.overflow = 'visible';
        }
        setCurrentIndex((currentIndex + 1) % popUps.length);
        setTimeout(showWindow, 5000);
    }, [currentIndex, popUps.length]); // Include popUps.length in dependency array
                            ...
                            <div className="pop-card position-relative d-flex align-items-center">
                                ...
                                <div className="text-start popup-text">
                                    ...
                                    <div className="fs-12">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" height="13" className="text-success ms-2 me-1" viewBox="0 0 512 512" fill="currentColor">
