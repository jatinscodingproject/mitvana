...
import { Features, HeaderLayout, HomePage1, HomePage2, ShopPage, ProductLayout, ProductDetail, ProductSwatch, ProductFeatures, ShopFeatures, HomeFashionShopSwiper, Portfolio, Lookbook, Blog, sale, salesSwiper } from '@src/common/Header/header';
...
const HeaderLookbookCollection = () => {
            ...
            <div id="kalles-section-header_top" className='demo' ref={headerRef}>
                ...
                <nav className={`navbar navbar-expand-lg navbar-custom  py-0 d-flex align-items-center ${isStickyActive === true ? 'headerFixed' : ""}`}>
                    <div className="container-fluid">
                        ...
                        <Link className="navbar-brand me-0" href="/index">
                            ...
                            <div className="d-none d-lg-block mx-auto">
                                <ul className="navbar-nav mx-auto mb-2 mb-lg-0">
                                    <li className="nav-item dropdown dropdown-mega-xxl">
                                        <Link className={`nav-link ${showw === 1 ? "show" : ""}`} href="#" data-bs-toggle="dropdown" aria-expanded="false" onClick={() => handleClick(1)}>
                                            Demo
                                        </Link>
                                    ...
                                    <li className="nav-item dropdown dropdown-mega-xxl">
                                        <Link className={`nav-link position-relative ${showw === 2 ? "show" : ""}`} href="#" data-bs-toggle="dropdown" aria-expanded="false" onClick={() => handleClick(2)}>
                                                ...
                                                <Col lg={7} className="p-4">
                                                    <Row className="g-6">
                                                        ...
                                                        <div className="col-lg-6 cat-section ps-4 p-0">
                                                            <a href="shop-left-sidebar.html" className="d-block position-relative cat_grid_item overflow-hidden " style={{ height: "350px" }}>
                                    ...
                                    <li className="nav-item dropdown dropdown-mega-xxl">
                                        <Link className={`nav-link ${showw === 3 ? "show" : ""}`} href="#" data-bs-toggle="dropdown" aria-expanded="false" onClick={() => handleClick(3)}>
                                            Product
                                        </Link>
                                    ...
                                    <li className="nav-item dropdown dropdown-mega-3xl">
                                        <Link className={`nav-link position-relative text-danger ${showw === 4 ? 'show' : ""}`} href='#' data-bs-toggle="dropdown" aria-expanded="false" onClick={() => handleClick(4)}>
                                    ...
                                    <li className="nav-item dropdown dropdown-mega-lg">
                                        <Link className={`nav-link ${showw === 5 ? "show" : ""}`} href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" onClick={() => handleClick(5)}>
                                            Portfolio
                                        </Link>
                                    ...
                                    <li className="nav-item dropdown dropdown-mega-lg">
                                        <Link className={`nav-link ${showw === 6 ? "show" : ""}`} href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" onClick={() => handleClick(6)}>
                                            Lookbook
                                        </Link>
                                    ...
                                    <li className="nav-item dropdown dropdown-mega-lg">
                                        <Link className={`nav-link ${showw === 7 ? "show" : ""}`} href="#!" role="button" data-bs-toggle="dropdown" aria-expanded="false" onClick={() => handleClick(7)}>
                                            Blog
                                        </Link>
...
export default HeaderLookbookCollection