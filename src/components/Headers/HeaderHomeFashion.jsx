...
const HeaderHomeFashion = () => {
    ...
    const handleeSearchClose = () => setShow(false);
    ...
    return (
        <React.Fragment>
            ...
            <MobileHeaderSearchModel show={show} handleClose={handleeSearchClose} />
...
export default HeaderHomeFashion