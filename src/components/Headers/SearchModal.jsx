      ...
      <Offcanvas show={show} onHide={handleClose} placement="end">
        <Offcanvas.Header className="border-bottom">
          ...
          <button
            ...
            aria-label="Close"
          >
            <i className="pe-7s-close pegk" onClick={handleClose}></i>
          </button>
        </Offcanvas.Header>
        ...
        <div className="offcanvas-body">
          <Row className="mb-3">
            <div className="col-4">
              <Link href="#!">
                <Image src={product01} alt="" className="img-fluid" priority />
              </Link>
            </div>
            <div className="col-8">
              <h6 className="mb-2">
          ...
          <Row className="mb-3">
            <div className="col-4 pe-0">
              <Link href="#!">
                <Image src={product02} alt="" className="img-fluid" priority />
              </Link>
            </div>
            <div className="col-8">
              <h6 className="mb-2">
          ...
          <Row className="mb-3">
            <div className="col-4 pe-0">
              <Link href="#!">
                <Image src={product03} alt="" className="img-fluid" priority />
              </Link>
            </div>
            <div className="col-8">
              <h6 className="mb-2">
          ...
          <Row className="mb-3">
            <div className="col-4 pe-0">
              <Link href="#!">
                <Image src={product04} alt="" className="img-fluid" priority />
              </Link>
            </div>
            <div className="col-8">
              <h6 className="mb-2">
                <Link
                  href="/product-detail-layout-05"
                  className="product-title"
                >
                  stripe oilcloth
                </Link>
          ...
          <Row className="row mb-3">
            <div className="col-4 pe-0">
              <Link href="#!">
                <Image src={product05} alt="" className="img-fluid" priority />
              </Link>
            </div>
            <div className="col-8">
              <h6 className="mb-2">
        ...
        <div className="py-4 border-top mx-4">
          <Link href="#" className="detail_link fs-14 fw-semibold">
            View All <i className="las la-arrow-right fs__18"></i>
          </Link>
        </div>
      </Offcanvas>
    </React.Fragment>
